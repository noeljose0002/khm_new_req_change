							...
							<div class="page-rightheader">
								<div class="ml-3 ml-auto d-flex">
									...
									<span class="mt-3 mt-md-0 pg-header">
										<a href="<?=site_url('Dashboard/add_object_rc/');?>" class="btn btn-success ml-0 ml-md-4 mt-1 "><i class="typcn typcn-plus mr-1"></i>Create New</a>
									</span>
								</div>
							</div>
						</div>
...
$(document).ready(function() {
    ...
    $('#ss_table').DataTable({
		...
		'ajax': {
                'url': '<?=site_url('Dashboard/rc_list_view');?>',
                'type': 'POST'
            },
            'columns': [{
            ...
            },
			{
                ...
                render: function (data, type, row, meta) {
					return '<a data-toggle="tooltip" data-original-title="Edit" href="<?=site_url('Dashboard/add_object_rc/');?>/'+data+'"><i class="fa fa-edit" style="color:#339966"></i></a>';
                }
            }
