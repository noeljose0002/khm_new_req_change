...
use App\Models\BestDestinationReportModel;
...
class BestDestinationReport extends Controller
{
    /** @var BestDestinationReportModel */
    protected $BestDestinationReportModel;
    ...
    public function initController(
        ...
        $this->BestDestinationReportModel = new BestDestinationReportModel();
    }
    ...
    public function index()
    {
        ...
        return view('masters/best_destination_report_list', $data);
    }

    public function destination(): ResponseInterface
    {
        $model  = new BestDestinationReportModel();
        $destination = $model->getAllLocations();
    ...
    public function data()
    {
        ...
        $destinationId  = $this->request->getGet('destination_id', FILTER_SANITIZE_STRING);
        ...
        // Fetch data
        $rows = $this->BestDestinationReportModel->getByDateRange($fromYmd, $toYmd,$destinationId,$system);
