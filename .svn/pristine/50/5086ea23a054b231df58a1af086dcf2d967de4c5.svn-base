...
<body class="app sidebar-mini">
    ...
    <div class="page">
        <div class="page-main">
            ...
            <div class="app-content icon-content">
                <div class="section">
                    ...
                    <div class="page-header">
                        <div class="page-leftheader">
                            <h4 class="page-title mb-0">Entity Attributr Assign</h4>
                ...
                <head>
                    <meta charset="UTF-8">
                    <title>Cost Component Management</title>
                    ...
                    <style>
                        ...
                        /* #costComponentTable thead {
                            background: #004d00;
                            color: #fff;
                        } */

                        #costComponentTable tbody tr:hover {
                            background: #d4edda;
                        }
                        ...
                        /* Maintain consistent UI for multiple selects */
                        ...
                        /* Make the query expression box larger */
                        #queryExpression {
                            height: 150px;
                            font-size: 1.1em;
                        }

                        /* Styles for tokens in Query Builder */
                        .token {
    ...
    <div class="container my-4">
        <div style="width:100%; margin:auto;">
            <div class="card mb-4">
                <div class="card-header bg-success text-white">ADD Cost Component</div>
                <div class="card-body">
                    <div id="costComponentFormContainer">
                        <h4 id="formTitle">Add New Cost Component</h4>
                        <form id="costComponentForm">
                            <input type="hidden" id="cost_component_id" name="cost_component_id">

                            <div class="form-row">
                                <div class="form-group col-md-4">
                                    <label for="cost_component_type_id">Component Type</label>
                                    <select id="cost_component_type_id" name="cost_component_type_id" class="form-control"></select>
                                    <div class="invalid-feedback"></div>
                                </div>
                                <div class="form-group col-md-4">
                                    <label for="cost_component_type_name">Component Name</label>
                                    <input type="text" id="cost_component_type_name" name="cost_component_type_name" class="form-control" placeholder="Enter component name">
                                    <div class="invalid-feedback"></div>
                                </div>
                                <div class="form-group col-md-4">
                                    <label for="cost_component_type_tariff_seek_table">Tariff Seek Table</label>
                                    <select id="cost_component_type_tariff_seek_table" name="cost_component_type_tariff_seek_table[]" class="form-control" multiple></select>
                                    <div class="invalid-feedback"></div>
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-4">
                                    <label for="cost_component_type_itinerary_tariff_fields">Itinerary Tariff Fields</label>
                                    <select id="cost_component_type_itinerary_tariff_fields" name="cost_component_type_itinerary_tariff_fields[]" class="form-control" multiple></select>
                                    <div class="invalid-feedback"></div>
                                </div>
                                <div class="form-group col-md-4">
                                    <label for="cost_component_type_qty_seek_table">Qty Seek Table</label>
                                    <select id="cost_component_type_qty_seek_table" name="cost_component_type_qty_seek_table[]" class="form-control" multiple></select>
                                    <div class="invalid-feedback"></div>
                                </div>
                                <div class="form-group col-md-4">
                                    <label for="cost_component_type_itinerary_qty_fields">Itinerary Qty Fields</label>
                                    <select id="cost_component_type_itinerary_qty_fields" name="cost_component_type_itinerary_qty_fields[]" class="form-control" multiple></select>
                                    <div class="invalid-feedback"></div>
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-4">
                                    <label for="cost_component_type_value_seek_table">Value Seek Table</label>
                                    <select id="cost_component_type_value_seek_table" name="cost_component_type_value_seek_table[]" class="form-control" multiple></select>
                                    <div class="invalid-feedback"></div>
                                </div>
                                <div class="form-group col-md-4">
                                    <label for="cost_component_type_value_seek_field">Value Seek Fields</label>
                                    <select id="cost_component_type_value_seek_field" name="cost_component_type_value_seek_field[]" class="form-control" multiple></select>
                                    <div class="invalid-feedback"></div>
                                </div>
                                <div class="form-group col-md-4">
                                    <label for="cost_element_type_expression">Expression</label>
                                    <textarea id="cost_element_type_expression" name="cost_element_type_expression" class="form-control" placeholder="Enter expression"></textarea>
                                    <div class="invalid-feedback"></div>
                                    <button type="button" id="openQueryBuilderBtn" class="btn btn-info mt-2">Open Query Builder</button>
                                </div>
                            </div>
    ...
    <div class="container my-4">
        <div class="d-flex justify-content-end my-4">
            <input type="text" id="searchInput" class="form-control w-25" placeholder="Search Component Name">
        </div>
        <div class="card shadow">
            <div class="card-header bg-success text-white">Cost Components List</div>
            <div class="card-body">
                <div class="table-responsive">
                    <table id="costComponentTable" class="table table-bordered table-hover table-striped">
                        <thead>
                            <tr>
                                <th>ID</th>
                                <th>Component Type ID</th>
                                <th>Component Name</th>
                                <th>Tariff Seek Table</th>
                                <th>Itinerary Tariff Fields</th>
                                <th>Qty Seek Table</th>
                                <th>Itinerary Qty Fields</th>
                                <th>Value Seek Table</th>
                                <th>Value Seek Fields</th>
                                <th>Expression</th>
                                <th>Actions</th>
                            </tr>
                        </thead>
                        <tbody><!-- AJAX rows --></tbody>
                    </table>
                </div>
            </div>
        </div>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <!-- Expression Box with Clear Button -->
                    <div class="form-group">
                        <label for="queryExpression">Expression</label>
                        <textarea id="queryExpression" class="form-control" placeholder="Your SQL expression here..."></textarea>
                        <button type="button" id="clearExpressionBtn" class="btn btn-sm btn-warning mt-1">Clear</button>
                    </div>
                    <!-- SQL Functions Tokens Container -->
                    <div class="form-group">
                        <label>SQL Functions</label>
                        <div id="sqlFunctionsContainer" class="token-container">
                            <!-- Clickable SQL function tokens will be populated here -->
                        </div>
                    </div>
                    <!-- Tables Tokens Container -->
                    <div class="form-group">
                        <label>Tables</label>
                        <div id="queryTablesContainer" class="token-container">
                            <!-- Clickable table tokens will be populated here -->
                        </div>
                    </div>
                    <!-- Fields Tokens Container -->
                    <div class="form-group">
                        <label>Fields</label>
                        <div id="queryFieldsContainer" class="token-container">
                            <!-- Clickable field tokens will be populated here -->
                        </div>
                    </div>
                    <!-- Operators Box -->
                    <div class="form-group">
                        ...
                        <div id="operatorsBox">
                            <button type="button" class="btn btn-light operator-btn" data-val="+">+</button>
                            <button type="button" class="btn btn-light operator-btn" data-val="-">-</button>
                            <button type="button" class="btn btn-light operator-btn" data-val="*">*</button>
                            <button type="button" class="btn btn-light operator-btn" data-val="/">/</button>
                            <button type="button" class="btn btn-light operator-btn" data-val="=">=</button>
                ...
                <div class="modal-footer">
                    <!-- Save Query transfers the built expression -->
                    <button type="button" id="saveQueryBtn" class="btn btn-primary">Save Query</button>
...
<!-- 2) Bootstrap’s JS (bundle includes Popper) -->
<script src="https://cdn.jsdelivr.net/npm/bootstrap@4.6.0/dist/js/bootstrap.bundle.min.js"></script>
<!-- 3) Your own script that calls $('.modal') -->
<script src="/js/SuperAdminCostComponent.js"></script>
<script src="https://code.jquery.com/jquery-3.3.1.min.js"></script>
...
var tariffSeekMapping = {},
    qtySeekMapping = {},
    valueSeekMapping = {},
    preselectedItineraryTariffFields = [],
    preselectedItineraryQtyFields = [],
    preselectedValueFields = [],
    formSubmitted = false;

// SQL Functions tokens to be shown in the Query Builder
var sqlFunctions = ["WITH", "AS", "SELECT", "FROM", "WHERE", "HAVING", "GROUP BY", "ORDER BY", "COUNT", "SUM", "AVG", "MIN", "MAX", "GROUP_CONCAT"];

// Validation functions
function validateField(id, force = false){
  var $f = $("#" + id), val = $f.val(), err = "";
  if(!force && !$f.data("touched")) return true;
  if(id=="cost_component_type_id" && !val)
    err = "Please select a Component Type.";
  else if(id=="cost_component_type_name"){
    if(!$.trim(val))
      err = "Please enter a Component Name.";
    else if(!/^(?!\s)(?!.*\s{2,})(?=(?:.*[A-Za-z]){3,})[A-Za-z ]+$/.test(val))
      err = "Component Name must contain only alphabets and spaces, must not start with a space, have only one space between words, and contain at least 3 letters.";
  }
  else if(id=="cost_component_type_tariff_seek_table" && (!val || !val.length))
    err = "Please select at least one Tariff Seek Table.";
  else if(id=="cost_component_type_itinerary_tariff_fields" && (!val || !val.length))
    err = "Please select at least one Itinerary Tariff Field.";
  else if(id=="cost_component_type_qty_seek_table" && (!val || !val.length))
    err = "Please select at least one Qty Seek Table.";
  else if(id=="cost_component_type_itinerary_qty_fields" && (!val || !val.length))
    err = "Please select at least one Itinerary Qty Field.";
  else if(id=="cost_component_type_value_seek_table" && (!val || !val.length))
    err = "Please select at least one Value Seek Table.";
  else if(id=="cost_component_type_value_seek_field" && (!val || !val.length))
    err = "Please select at least one Value Seek Field.";
  else if(id=="cost_element_type_expression" && !$.trim(val))
    err = "Please enter an Expression.";
    
  var $fb = $f.siblings(".invalid-feedback").stop(true, true);
  if(err){
    $f.addClass("is-invalid").removeClass("is-valid");
    $fb.css({"color": "red", "opacity": 1}).text(err).show();
    return false;
  } else {
...
function validateAllFields(){
  return ["cost_component_type_id","cost_component_type_name",
          "cost_component_type_tariff_seek_table","cost_component_type_itinerary_tariff_fields",
          "cost_component_type_qty_seek_table","cost_component_type_itinerary_qty_fields",
          "cost_component_type_value_seek_table","cost_component_type_value_seek_field",
          "cost_element_type_expression"].every(id => validateField(id, true));
}



// Updated loadCostComponents() to display names for tariff, qty, and value seek tables
function loadCostComponents(){
  $.getJSON("<?= site_url('SuperAdminCostComponent/list') ?>", function(data){
    var rows = "";
    $.each(data, function(i, comp){
      // Parse Tariff Seek Tables
      var tariffArray = [];
      try {
         tariffArray = JSON.parse(comp.cost_component_type_tariff_seek_table);
      } catch(e){ }
      if (!Array.isArray(tariffArray)) {
        tariffArray = [];
      }
      var tariffNames = tariffArray.map(function(id){
         return tariffSeekMapping[id.toString()] || id;
      }).join(", ");
      
      // Parse Qty Seek Tables
      var qtyArray = [];
      try {
         qtyArray = JSON.parse(comp.cost_component_type_qty_seek_table);
      } catch(e){ }
      if (!Array.isArray(qtyArray)) {
        qtyArray = [];
      }
      var qtyNames = qtyArray.map(function(id){
         return qtySeekMapping[id.toString()] || id;
      }).join(", ");
      
      // Parse Value Seek Tables with array check to prevent errors.
      var valueArray = [];
      try {
         valueArray = JSON.parse(comp.cost_component_type_value_seek_table) || [];
      ...
      var valueNames = valueArray.map(function(id){
         return valueSeekMapping[id.toString()] || id;
      }).join(", ");
      
      rows += '<tr><td>' + comp.cost_component_id + '</td>' +
              '<td>' + comp.cost_component_type_id + '</td>' +
              '<td>' + comp.cost_component_type_name + '</td>' +
              '<td>' + tariffNames + '</td>' +
              '<td>' + (comp.cost_component_type_itinerary_tariff_fields || '') + '</td>' +
              '<td>' + qtyNames + '</td>' +
              '<td>' + (comp.cost_component_type_itinerary_qty_fields || '') + '</td>' +
              '<td>' + valueNames + '</td>' +
              '<td>' + (comp.cost_component_type_value_seek_field || '') + '</td>' +
              '<td>' + comp.cost_element_type_expression + '</td>' +
              '<td class="action-btns"><button class="btn btn-info btn-sm editBtn" data-id="' + comp.cost_component_id + '"><i class="fa fa-edit"></i></button>' +
              '<button class="btn btn-danger btn-sm deleteBtn" data-id="' + comp.cost_component_id + '"><i class="fa fa-trash"></i></button></td></tr>';
    });
    $("#costComponentTable tbody").html(rows);
  });
}

// Load component types
function loadComponentTypes(){
  $.getJSON("<?= site_url('SuperAdminCostComponent/loadComponentTypes') ?>", function(data){
    var opts = '<option value="">Select Component Type</option>';
    $.each(data, function(i, type){
      opts += '<option value="' + type.cost_component_type_id + '">' + type.cost_component_type_name + '</option>';
    });
    $("#cost_component_type_id").html(opts);
  });
}

// Load tariff seek tables and build mapping
function loadTariffSeekTables(){
  return $.ajax({
    url: "<?= site_url('SuperAdminCostComponent/loadTariffSeekTables') ?>",
    method: "GET",
    dataType: "json",
    success: function(data){
      var opts = "";
      $.each(data, function(i, table){
        tariffSeekMapping[table.table_id.toString()] = table.table_name;
        opts += '<option value="' + table.table_id + '">' + table.table_name + '</option>';
      });
      $("#cost_component_type_tariff_seek_table").html(opts).select2({
        dropdownParent: $('#costComponentFormContainer'),
        width: '100%',
        allowClear: true,
        placeholder: "Select Tariff Seek Tables"
      });
    }
  });
}

// Load quantity seek tables and build mapping
function loadQtySeekTables(){
  return $.ajax({
    url: "<?= site_url('SuperAdminCostComponent/loadQtySeekTables') ?>",
    method: "GET",
    dataType: "json",
    success: function(data){
      var opts = "";
      $.each(data, function(i, table){
        qtySeekMapping[table.table_id.toString()] = table.table_name;
        opts += '<option value="' + table.table_id + '">' + table.table_name + '</option>';
      });
      $("#cost_component_type_qty_seek_table").html(opts).select2({
        dropdownParent: $('#costComponentFormContainer'),
        width: '100%',
        allowClear: true,
        placeholder: "Select Qty Seek Tables"
      });
    }
  });
}

// Load value seek tables and build mapping
function loadValueSeekTables(){
  return $.ajax({
    url: "<?= site_url('SuperAdminCostComponent/loadValueSeekTables') ?>",
    method: "GET",
    dataType: "json",
    success: function(data){
      var opts = "";
      $.each(data, function(i, table){
        valueSeekMapping[table.table_id.toString()] = table.table_name;
        opts += '<option value="' + table.table_id + '">' + table.table_name + '</option>';
      });
      $("#cost_component_type_value_seek_table").html(opts).select2({
        dropdownParent: $('#costComponentFormContainer'),
        width: '100%',
        allowClear: true,
        placeholder: "Select Value Seek Tables"
      });
    }
  });
}
...
/* 
  Updated loadOptions function for loading itinerary fields (tariff, qty, or value).
  Each option’s value is set as "tableId|fieldname".
*/
function loadOptions(url, tableIds, target, preselected) {
  ...
  var promises = tableIds.map(function(tableId) {
    return $.ajax({
      ...
      return data.map(function(field) {
        return $.extend({}, field, { tableId: tableId });
      });
    });
  });
  ...
  Promise.all(promises).then(function(results) {
    var allFields = [];
    results.forEach(function(fieldsArray) {
      allFields = allFields.concat(fieldsArray);
    });
    var options = "";
    allFields.forEach(function(field){
      var prefix = "";
      if(url.indexOf("loadItineraryTariffFields") !== -1) {
         prefix = tariffSeekMapping[field.tableId.toString()] || "";
      } else if(url.indexOf("loadQuantityFields") !== -1) {
         prefix = qtySeekMapping[field.tableId.toString()] || "";
      } else if(url.indexOf("loadValueFields") !== -1) {
         prefix = valueSeekMapping[field.tableId.toString()] || "";
      }
      var optionValue = field.tableId + '|' + field.table_field_name;
      var displayText = prefix ? prefix + "." + field.table_field_name : field.table_field_name;
...
$(document).ready(function(){
  // Initialize select2 for itinerary fields
  $('#cost_component_type_itinerary_tariff_fields, #cost_component_type_itinerary_qty_fields, #cost_component_type_value_seek_field').select2({
    dropdownParent: $('#costComponentFormContainer'),
    width: '100%',
    allowClear: true,
    placeholder: "Select Options"
  ...
  $('#cost_component_type_tariff_seek_table, #cost_component_type_qty_seek_table, #cost_component_type_value_seek_table, #cost_component_type_id').select2({
    dropdownParent: $('#costComponentFormContainer'),
    width: '100%',
    allowClear: true,
  ...
  $("#cost_component_type_id, #cost_component_type_tariff_seek_table, #cost_component_type_itinerary_tariff_fields, #cost_component_type_qty_seek_table, #cost_component_type_itinerary_qty_fields, #cost_component_type_value_seek_table, #cost_component_type_value_seek_field")
    .on("change blur", function(){ $(this).data("touched", true); validateField(this.id); });
  $("#cost_component_type_name, #cost_element_type_expression").on("keyup blur", function(){ $(this).data("touched", true); validateField(this.id); });
  
  // When tariff seek tables change, load the itinerary tariff fields.
  $("#cost_component_type_tariff_seek_table").change(function(){
    var selected = $(this).val();
    loadOptions("<?= site_url('SuperAdminCostComponent/loadItineraryTariffFields') ?>", selected, "#cost_component_type_itinerary_tariff_fields", preselectedItineraryTariffFields);
    validateField("cost_component_type_tariff_seek_table");
  });
  // For quantity seek tables.
  $("#cost_component_type_qty_seek_table").change(function(){
    var selected = $(this).val();
    loadOptions("<?= site_url('SuperAdminCostComponent/loadQuantityFields') ?>", selected, "#cost_component_type_itinerary_qty_fields", preselectedItineraryQtyFields);
    validateField("cost_component_type_qty_seek_table");
  });
  // For value seek tables.
  $("#cost_component_type_value_seek_table").change(function(){
    var selected = $(this).val();
    loadOptions("<?= site_url('SuperAdminCostComponent/loadValueFields') ?>", selected, "#cost_component_type_value_seek_field", preselectedValueFields);
    validateField("cost_component_type_value_seek_table");
  });
  
  $("#costComponentForm").submit(function(e){
    e.preventDefault();
    formSubmitted = true;
    ...
    $.ajax({
      ...
      url: "<?= site_url('SuperAdminCostComponent/save') ?>",
      method: "POST",
      data: $(this).serialize(),
      dataType: "json",
      success: function(response){
        if(response.status === 'success'){
          $("#costComponentForm")[0].reset();
          $("#cost_component_id").val("");
          $("#formTitle").text("Add New Cost Component");
          $("#saveBtn").text("Save");
          $("#cancelEditBtn").hide();
          $('#cost_component_type_id, #cost_component_type_tariff_seek_table, #cost_component_type_itinerary_tariff_fields, #cost_component_type_qty_seek_table, #cost_component_type_itinerary_qty_fields, #cost_component_type_value_seek_table, #cost_component_type_value_seek_field')
            .val(null).trigger('change').removeClass("is-invalid").siblings(".invalid-feedback").text("").hide();
          loadCostComponents();
          Swal.fire('Success', 'Cost component saved successfully.', 'success');
          $("input, select, textarea").removeData("touched");
          formSubmitted = false;
        } else {
...
function parseAndNormalize(field){
  var arr = [];
  if(field){
    try { arr = JSON.parse(field); }
    catch(e){ arr = Array.isArray(field) ? field : [field]; }
  }
...
$(document).on('click', '.editBtn', function(){
  $.getJSON("SuperAdminCostComponent/get", { id: this.dataset.id }, function(data){
    if(!data) return;

    // simple fields
    $('#cost_component_id').val(data.cost_component_id);
    $('#cost_component_type_id').val(data.cost_component_type_id).trigger('change');
    $('#cost_component_type_name').val(data.cost_component_type_name);
    $('#cost_element_type_expression').val(data.cost_element_type_expression);

    // prepare arrays
    var tariffArr = parseAndNormalize(data.cost_component_type_tariff_seek_table),
        qtyArr    = parseAndNormalize(data.cost_component_type_qty_seek_table),
        valueArr  = parseAndNormalize(data.cost_component_type_value_seek_table);

    preselectedItineraryTariffFields = parseAndNormalize(data.cost_component_type_itinerary_tariff_fields);
    preselectedItineraryQtyFields    = parseAndNormalize(data.cost_component_type_itinerary_qty_fields);
    preselectedValueFields           = parseAndNormalize(data.cost_component_type_value_seek_field);

    // set the seek-tables immediately
    $('#cost_component_type_tariff_seek_table').val(tariffArr).trigger('change');
    $('#cost_component_type_qty_seek_table').val(qtyArr).trigger('change');
    $('#cost_component_type_value_seek_table').val(valueArr).trigger('change');

    // the change handlers on those selects will call loadOptions(…)
    // which will load <option>s and then apply preselected* arrays

    // UI tweaks
    $('#formTitle').text('Edit Cost Component');
    $('#saveBtn').text('Update');
    $('#cancelEditBtn').show();
    $('input, select, textarea').data('touched', true);
  });
});
  ...
  $(document).on("click", ".deleteBtn", function(){
    ...
    Swal.fire({
      title: 'Are you sure?',
      text: "This will delete/restore the cost component.",
      icon: 'warning',
      ...
      if(result.isConfirmed){
        $.ajax({
          url: "<?= site_url('SuperAdminCostComponent/delete') ?>",
          method: "POST",
          data: { id: id },
          dataType: "json",
          success: function(response){
  ...
  $("#searchInput").on("keyup", function(){
    ...
    $("#costComponentTable tbody tr").filter(function(){
      $(this).toggle($(this).find("td:nth-child(3)").text().toLowerCase().indexOf(val) > -1);
    });
  });
  
  loadComponentTypes();
  $.when(loadTariffSeekTables(), loadQtySeekTables(), loadValueSeekTables()).done(loadCostComponents);
  
  // ----------------- Query Builder Dynamic Append ------------------
  // Populate SQL Functions Container
  function populateSQLFunctions(){
    var container = $("#sqlFunctionsContainer");
    container.empty();
    sqlFunctions.forEach(function(func){
      var tokenEl = $("<span>").addClass("token").text(func);
      tokenEl.on("click", function(){
        $("#queryExpression").val($("#queryExpression").val() + func + " ");
      });
      container.append(tokenEl);
    });
  }
  
  // Clear the query expression box
  $("#clearExpressionBtn").click(function(){
    $("#queryExpression").val('');
  });
  
  // Function to populate the Tables container based on selections from the main UI
  function populateQueryTables(){
    var tariffTables = $("#cost_component_type_tariff_seek_table").val() || [];
    var qtyTables = $("#cost_component_type_qty_seek_table").val() || [];
    var valueTables = $("#cost_component_type_value_seek_table").val() || [];
    var allTables = [];
    
    tariffTables.forEach(function(id){
      if(tariffSeekMapping[id])
         allTables.push(tariffSeekMapping[id]);
    });
    qtyTables.forEach(function(id){
      if(qtySeekMapping[id])
         allTables.push(qtySeekMapping[id]);
    });
    valueTables.forEach(function(id){
      if(valueSeekMapping[id])
         allTables.push(valueSeekMapping[id]);
    });
    // Remove duplicates
    allTables = allTables.filter(function(item, pos) {
      return allTables.indexOf(item) === pos;
    });
    var container = $("#queryTablesContainer");
    container.empty();
    allTables.forEach(function(table){
      var tokenEl = $("<span>").addClass("token").text(table);
      tokenEl.on("click", function(){
        $("#queryExpression").val($("#queryExpression").val() + table + " ");
      });
      container.append(tokenEl);
    });
  }
  
  // Function to populate the Fields container based on itinerary fields from main UI
  function populateQueryFields(){
    var tariffFields = $("#cost_component_type_itinerary_tariff_fields").val() || [];
    var qtyFields = $("#cost_component_type_itinerary_qty_fields").val() || [];
    var valueFields = $("#cost_component_type_value_seek_field").val() || [];
    var allFields = tariffFields.concat(qtyFields, valueFields);
    // Remove duplicates
    allFields = allFields.filter(function(item, pos) {
      return allFields.indexOf(item) === pos;
    });
    var container = $("#queryFieldsContainer");
    container.empty();
    allFields.forEach(function(field){
      var parts = field.split('|');
      var displayText = parts.length > 1 ? ((tariffSeekMapping[parts[0]] || qtySeekMapping[parts[0]] || valueSeekMapping[parts[0]]) + "." + parts[1]) : field;
      var tokenEl = $("<span>").addClass("token").text(displayText);
      tokenEl.on("click", function(){
        $("#queryExpression").val($("#queryExpression").val() + displayText + " ");
      });
      container.append(tokenEl);
    });
  }
  
  // When opening the Query Builder, update the token containers and clear expression
  $("#openQueryBuilderBtn").click(function(){
    // $("#queryExpression").val('');
    $("#queryExpression").val($("#cost_element_type_expression").val());
    populateSQLFunctions();
    populateQueryTables();
    populateQueryFields();
  ...
  $(".operator-btn").click(function(){
    var op = $(this).data("val");
    $("#queryExpression").val($("#queryExpression").val() + " " + op + " ");
  });
  
  // Save Query: transfer expression to the main expression field and close modal.
  $("#saveQueryBtn").click(function(){
    $("#cost_element_type_expression").val($("#queryExpression").val());
