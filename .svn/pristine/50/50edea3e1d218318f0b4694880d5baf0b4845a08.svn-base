...
use App\Models\MonthlyTargetReportModel;
...
{
    /** @var MonthlyTargetReportModel */
    protected $MonthlyTargetReportModel;
    ...
    public function initController(
        ...
        $this->MonthlyTargetReportModel = new MonthlyTargetReportModel();
    }
    ...
    public function index()
    {
        ...
        return view('masters/monthly_target_report_list', $data);
    }
    ...
    public function data()
    {
        ...
        $executive_id  = $this->request->getGet('executive_id');
        $target_id  = $this->request->getGet('target_id');
        ...
        // Fetch data
        $rows = $this->MonthlyTargetReportModel->getByDateRange($fromYmd, $toYmd, $executive_id, $target_id,$system);

        return $this->response->setJSON(['data' => $rows]);
    }

    public function executive(): ResponseInterface
    {
        $model  = new MonthlyTargetReportModel();
        $executive = $model->getAllEmployees();
    ...
    public function target(): ResponseInterface
    {
        $model  = new MonthlyTargetReportModel();
        $executive = $model->getAllTargets();
