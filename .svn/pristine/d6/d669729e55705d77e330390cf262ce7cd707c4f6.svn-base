    ...
    <div class="page">
        <div class="page-main">
            ...
            <div class="app-content icon-content">
                <div class="section">
                    ...
                    <div class="page-header">
                        <div class="page-leftheader">
                            <h4 class="page-title mb-0">Pending Arrival Report</h4>
                ...
                <head>
                    <meta charset="utf-8">
                    <title> Pending Arrival Report</title>
                    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
                ...
                <body class="p-4">
                    ...
                    <div id="filterContainer">
                        <!-- <center><h4 class="mb-4">Arrival Report</h4></center> -->
                        <div class="card">
                            <div class="card-body">
                    ...
                    <div id="tableContainer">
                        <div class="card">
                            <div class="card-body p-4">
                                <table id="pendingReportTable" style="width: 100%;">
                                    <thead>
                                        <tr>
                                            <th>Arrival Time</th>
                                            <th>Guest</th>
...
<script>
    ...
    $(function() {
        ...
        var table = $('#pendingReportTable').DataTable({
            dom: '<"row"<"col-sm-12 col-md-6"B><"col-sm-12 col-md-6"f>><"row"<"col-sm-12"tr>><"row"<"col-sm-12 col-md-5"i><"col-sm-12 col-md-7"lp>>',
            buttons: [{
                extend: 'excelHtml5',
                text: 'Export Excel',
                className: 'btn btn-outline-primary',
                title: 'Pending Arrival Report',
                filename: 'pending_arrival_report_' + moment().format('YYYYMMDD_HHmmss'),
                exportOptions: {
                    columns: ':visible',
                    // format: {
            ...
            serverSide: false,
            ajax: {
                url: '<?= site_url("PendingArrivalReport/data") ?>',
                data: function(d) {
            ...
            columns: [{
                ...
                },
                {
                    data: 'call_date',
                    render: function(data) {
                        return data ? moment(data, 'YYYY-MM-DD HH:mm:ss').format('DD-MM-YYYY HH:mm:ss') : '';
                    }
                },
                {
                ...
                {
                    title: 'Driver Name', // Heading text
                    data: 'drivername', // No matching field in AJAX data
                ...
                },
                {
                    ...
                    render: function(data, type) {
                        if (!data) return '';
                        // **parse** as DD‑MM‑YYYY HH:mm:ss (or fallback to DD‑MM‑YYYY)
                        var m = moment(data, ['YYYY-MM-DD HH:mm:ss', 'DD-MM-YYYY']);
                        if (type === 'display' || type === 'filter') {
                            // show exactly DD‑MM‑YYYY HH:mm:ss (or omit time if midnight)
                            return m.format(data.length > 10 ? 'YYYY-MM-DD HH:mm:ss' : 'DD-MM-YYYY');
                        }
