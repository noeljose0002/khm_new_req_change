    ...
    <div class="page">
        <div class="page-main">
            ...
            <div class="app-content icon-content">
                <div class="section">
                    ...
                    <div class="page-header">
                        <div class="page-leftheader">
                            <h4 class="page-title mb-0">Guest Tracking Report</h4>
                ...
                <head>
                    <meta charset="utf-8">
                    <title> Guest Tracking Report</title>
                    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
                    ...
                    <style>
                        ...
                        #guesttrackingReportTable thead th {
                ...
                <body class="p-4">
                    ...
                    <div id="filterContainer">
                        <!-- <center><h4 class="mb-4">Guest Tracking Report</h4></center> -->
                        <div class="card">
                            <div class="card-body">
                                <div class="form-inline filter-row align-items-center">
                                    <div class="form-group ml-3">
                                        <label for="filtering_datatble" class="mr-2">Search</label>
                                        <select id="filtering_datatble" class="form-control">
                                    ...
                                    <div class="form-group">
                                        <label for="from_date" class="mr-2">Date:</label>
                    ...
                    <div id="tableContainer">
                        <div class="card">
                            <div class="card-body p-4">
                                <table id="guesttrackingReportTable" style="width: 100%;">
                                    <thead>
                                        <tr>
...
<script>
    ...
    $(function() {
        ...
        var table = $('#guesttrackingReportTable').DataTable({
            dom: '<"row"<"col-sm-12 col-md-6"B><"col-sm-12 col-md-6"f>><"row"<"col-sm-12"tr>><"row"<"col-sm-12 col-md-5"i><"col-sm-12 col-md-7"lp>>',
            buttons: [{
                extend: 'excelHtml5',
                text: 'Export Excel',
                className: 'btn btn-outline-primary',
                title: 'Guest Tracking Report',
                filename: 'guest_tracking_report_' + moment().format('YYYYMMDD'),
                exportOptions: {
                    columns: ':visible',
                    // format: {
            ...
            serverSide: false,
            ajax: {
                url: '<?= site_url("GuestTrackingReport/data") ?>',
                data: function(d) {

                    d.from_date = convertDateToServerFormat($('#from_date').val());
                    d.filtering_datatble = ($('#filtering_datatble').val());
                    d.system = systemId;
        ...
        $('#filtering_datatble').on('change', function() {
            var mode = $(this).val();

            // Always start by showing all:
            table.columns().visible(true);

            if (mode === '2') {
                // “Hotel” filter ⇒ hide vehicle cols (idx 8,9,10,11)
                table.columns([8, 9, 10, 11]).visible(false);
            } else if (mode === '3') {
                // “Vehicle” filter ⇒ hide hotel cols (idx 6,7)
                table.columns([6, 7]).visible(false);
            }

            // now re-fetch the data (so `d.filtering_datatble` is sent to server)
            table.ajax.reload();
        });
