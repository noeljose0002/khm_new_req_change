...
<html lang="en" dir="ltr">
				...
				<div class="modal-dialog custom-modal-width" role="document">
					<div class="modal-content">
						<div class="modal-header" style="background-color:#339966;color:#fff;">
							<h5 class="modal-title" id="example-Modal3"><?php echo $ref_no; ?> - <?php echo $guest_name; ?> - Executive Followup</h5>
	...
	<div class="modal fade" id="transport_followup_modal" tabindex="-1" role="dialog"  aria-hidden="true">
				<div class="modal-dialog custom-modal-width" role="document">
					<div class="modal-content">
						<div class="modal-header" style="background-color:#339966;color:#fff;">
							<h5 class="modal-title" id="example-Modal3"><?php echo $ref_no; ?> - <?php echo $guest_name; ?> - Transport Followup</h5>
							<button type="button" class="close" data-dismiss="modal" aria-label="Close">
								<span aria-hidden="true">&times;</span>
							</button>
						</div>
			...
			<div class="modal fade" id="arrival_details_modal" tabindex="-1" role="dialog"  aria-hidden="true">
				<div class="modal-dialog custom-modal-width" role="document">
					<div class="modal-content">
						<div class="modal-header" style="background-color:#339966;color:#fff;">
							<h5 class="modal-title" id="example-Modal3"><?php echo $ref_no; ?> - <?php echo $guest_name; ?> - Arrival Details Followup</h5>
							<button type="button" class="close" data-dismiss="modal" aria-label="Close">
								<span aria-hidden="true">&times;</span>
							</button>
						</div>
			...
			<div class="modal fade" id="departure_details_modal" tabindex="-1" role="dialog"  aria-hidden="true">
				<div class="modal-dialog custom-modal-width" role="document">
					<div class="modal-content">
						<div class="modal-header" style="background-color:#339966;color:#fff;">
							<h5 class="modal-title" id="example-Modal3"><?php echo $ref_no; ?> - <?php echo $guest_name; ?> - Departure Details Followup</h5>
							<button type="button" class="close" data-dismiss="modal" aria-label="Close">
								<span aria-hidden="true">&times;</span>
							</button>
						</div>
		...
		<div class="modal fade" id="pre_arrivalcall_modal" tabindex="-1" role="dialog"  aria-hidden="true">
				<div class="modal-dialog custom-modal-width" role="document">
					<div class="modal-content">
						<div class="modal-header" style="background-color:#339966;color:#fff;">
							<h5 class="modal-title" id="example-Modal3"><?php echo $ref_no; ?> - <?php echo $guest_name; ?> - Pre Arrival Call Followup</h5>
							<button type="button" class="close" data-dismiss="modal" aria-label="Close">
								<span aria-hidden="true">&times;</span>
							</button>
						</div>
			...
			<div class="modal fade" id="arrivalcall_modal" tabindex="-1" role="dialog"  aria-hidden="true">
				<div class="modal-dialog custom-modal-width" role="document">
					<div class="modal-content">
						<div class="modal-header" style="background-color:#339966;color:#fff;">
							<h5 class="modal-title" id="example-Modal3"><?php echo $ref_no; ?> - <?php echo $guest_name; ?> - Arrival Call Followup</h5>
							<button type="button" class="close" data-dismiss="modal" aria-label="Close">
								<span aria-hidden="true">&times;</span>
							</button>
						</div>
			...
			<div class="modal fade" id="departurecall_modal" tabindex="-1" role="dialog"  aria-hidden="true">
				<div class="modal-dialog custom-modal-width" role="document">
					<div class="modal-content">
						<div class="modal-header" style="background-color:#339966;color:#fff;">
							<h5 class="modal-title" id="example-Modal3"><?php echo $ref_no; ?> - <?php echo $guest_name; ?> - Departure Call Followup</h5>
							<button type="button" class="close" data-dismiss="modal" aria-label="Close">
								<span aria-hidden="true">&times;</span>
							</button>
						</div>
		...
		<div class="modal fade" id="drivercall_modal" tabindex="-1" role="dialog"  aria-hidden="true">
				<div class="modal-dialog custom-modal-width" role="document">
					<div class="modal-content">
						<div class="modal-header" style="background-color:#339966;color:#fff;">
							<h5 class="modal-title" id="example-Modal3"><?php echo $ref_no; ?> - <?php echo $guest_name; ?> - Driver Call Followup</h5>
							<button type="button" class="close" data-dismiss="modal" aria-label="Close">
								<span aria-hidden="true">&times;</span>
							</button>
						</div>
...
<div class="modal fade displaycontent" id="viewItineraryModal" data-keyboard="false" data-backdrop="false">
												<div class="modal-dialog custom-modal-width" role="document">
													...
													<div class="modal-header custom-modal-header">
														<h5 class="modal-title" id="exampleModalLabel"><b><?php echo $ref_no; ?> - <?php echo $guest_name; ?> - Itinerary View - CS-<span id="iti_name_span"></span></b></h5>
	...
	<div class="modal fade displaycontent" id="viewFinalItineraryModal" data-keyboard="false" data-backdrop="false">
												<div class="modal-dialog custom-modal-width" role="document">
													<div class='modal-content'>
													<div class="modal-header custom-modal-header">
														<h5 class="modal-title" id="exampleModalLabel"><b><?php echo $ref_no; ?> - <?php echo $guest_name; ?> - Final Itinerary View - CS-<span id="final_iti_name_span"></span></b></h5>
														<button type="button" class="close" data-dismiss="modal" aria-label="Close" style="color:white;">
																		<span aria-hidden="true">&times;</span>
																	</button>

													</div>
													<div class="modal-body final_iti_tariff">
		...
		<div class="modal fade" id="hotelconfirmmodal" tabindex="-1" role="dialog"  aria-hidden="true">
				<div class="modal-dialog custom-modal-width" role="document">
					<div class="modal-content">
						<div class="modal-header" style="background-color:#339966;color:#fff;">
							<h5 class="modal-title" id="example-Modal3"><?php echo $ref_no; ?> - <?php echo $guest_name; ?> - Hotel Confirmation</h5>
							<button type="button" class="close" data-dismiss="modal" aria-label="Close">
								<span aria-hidden="true">&times;</span>
							</button>
						</div>
										...
										<div class="card-body">
											...
											<div class="modal fade displaycontent" id="sendmailDetailsModal" data-keyboard="false" data-backdrop="false">
												<div class="modal-dialog custom-modal-widths" role="document">
													<div class='modal-content'>
													<div class="modal-header" style="background-color:#339966;color:#fff;">
														<h5 class="modal-title" id="exampleModalLabel"><b><?php echo $ref_no; ?> - <?php echo $guest_name; ?> - Hotel Confirmation Mail</b></h5>
														<button type="button" class="close" data-dismiss="modal" aria-label="Close" style="color:white;">
																		<span aria-hidden="true">&times;</span>
																	</button>
											...
											<div class="modal fade displaycontent" id="transportItineraryModal" data-keyboard="false" data-backdrop="false">
												<div class="modal-dialog custom-modal-widths" role="document">
													<div class='modal-content'>
													<div class="modal-header custom-modal-header">
														<h5 class="modal-title" id="exampleModalLabel"><b><?php echo $ref_no; ?> - <?php echo $guest_name; ?> - Transport Itinerary</b></h5>
														<button type="button" class="close" data-dismiss="modal" aria-label="Close" style="color:white;">
																		<span aria-hidden="true">&times;</span>
																	</button>
											...
											<div class="modal fade displaycontent" id="hotelVoucherModal" data-keyboard="false" data-backdrop="false">
												<div class="modal-dialog custom-modal-widths" role="document">
													<div class='modal-content'>
													<div class="modal-header custom-modal-header">
														<h5 class="modal-title" id="exampleModalLabel"><b><?php echo $ref_no; ?> - <?php echo $guest_name; ?> - Hotel Vouchers</b></h5>
														<button type="button" class="close" data-dismiss="modal" aria-label="Close" style="color:white;">
																		<span aria-hidden="true">&times;</span>
																	</button>
											...
											<div class="modal fade displaycontent" id="ProformaGuestModal" data-keyboard="false" data-backdrop="false">
												<div class="modal-dialog custom-modal-widths" role="document">
													<div class='modal-content'>
													<div class="modal-header custom-modal-header">
														<h5 class="modal-title" id="exampleModalLabel"><b><?php echo $ref_no; ?> - <?php echo $guest_name; ?> - Proforma Guest Copy</b></h5>
														<button type="button" class="close" data-dismiss="modal" aria-label="Close" style="color:white;">
																		<span aria-hidden="true">&times;</span>
																	</button>
											...
											<div class="modal fade displaycontent" id="ProformaOfficeModal" data-keyboard="false" data-backdrop="false">
												<div class="modal-dialog custom-modal-widths" role="document">
													<div class='modal-content'>
													<div class="modal-header custom-modal-header">
														<h5 class="modal-title" id="exampleModalLabel"><b><?php echo $ref_no; ?> - <?php echo $guest_name; ?> - Proforma Office Copy</b></h5>
														<button type="button" class="close" data-dismiss="modal" aria-label="Close" style="color:white;">
																		<span aria-hidden="true">&times;</span>
																	</button>
											...
											<div class="modal fade displaycontent" id="vouchermodal" data-keyboard="false" data-backdrop="false">
												<div class="modal-dialog custom-modal-width" role="document">
													...
													<div class="modal-header custom-modal-header" style="background-color:#666699;color:#fff;">
														<h5 class="modal-title" id="exampleModalLabel"><b><?php echo $ref_no; ?> - <?php echo $guest_name; ?> - Hotel Voucher</b></h5>
														<button type="button" class="close" data-dismiss="modal" aria-label="Close" style="color:white;">
																		<span aria-hidden="true">&times;</span>
																	</button>
								...
								<div class="card">
									<div class="card-body">
										...
										<div class="row" style="padding-top:15px;">
											...
											<div class="col-xl-4">
												<button type="button" id="btn_final_itinerary" class="btn btn-success view_final_iti_sheet" data-did = <?php echo $enquiry_ref_id; ?> data-tid = <?php echo $tour_plan_ref_id; ?> data-eid = <?php echo $extension_ref_id; ?> data-id = <?php echo $confirm_cs_id; ?> <?php echo $dis_abled; ?>>Final Itinerary</button>
											</div>
											<div class="col-xl-4">
...
<script>
    $(document).on('click', '.view_final_iti_sheet', function (e) {
        e.preventDefault();
        ...
        $.ajax({
            type: "POST",
            url: "<?= site_url('Enquiry/viewFinalItinerarySheet'); ?>",
            data: {
                id: id,
                extension_ref_id: extension_ref_id,
                tourplan_ref_id: tourplan_ref_id,
            ...
            dataType: 'html',
            success: function (response) {
                $('.final_iti_tariff').html(response);
                $('#final_iti_name_span').text(id);
                $('#viewFinalItineraryModal').appendTo('body');
                $('#viewFinalItineraryModal').modal('show');
                $('#viewFinalItineraryModal').on('shown.bs.modal', function () {
                    tinymce.remove('#final_iti_sheet_template');
                    tinyMCE.init({
                        theme: "advanced",
                        theme_advanced_toolbar_location: "top",
                        theme_advanced_toolbar_align: "left",
                        mode: "exact",
                        elements: "final_iti_sheet_template",
						readonly: true
                    });
                });
            }
...
<script>
    $(document).on('click', '.view_placard', function (e) {
        ...
        var touracle_img = '<img src="<?php echo base_url('assets/images/logo_foot_nw.png');?>" alt="Touracle" style="max-width: 500px; height: auto;">';

        // Decide what text to show
        var display_text = agent_name
            ? `<div style="display: flex; flex-direction: column; align-items: center;">
                    ${agent_name}
                    <span style="text-decoration: underline; margin-top: 20px;">WELCOMES</span>
                    <span style="margin-top: 20px;">${guest_name}</span>
               </div>`
            : `<div style="display: flex; flex-direction: column; align-items: center;">
                    ${touracle_img}
                    <span style="text-decoration: underline; margin-top: 20px;">WELCOMES</span>
