...
use App\Models\ArrivalReportModel;
...
class ArrivalReport extends Controller
{
    /** @var ArrivalReportModel */
    protected $ArrivalReportModel;
    ...
    public function initController(
        ...
        $this->ArrivalReportModel = new ArrivalReportModel();
    }
    ...
    public function index()
    {
        ...
        return view('masters/arrival_report_list',$data);
    }
    ...
    public function data()
    {
        ...
        // Fetch data
        $rows = $this->ArrivalReportModel->getByDateRange($fromYmd, $toYmd, $system);
