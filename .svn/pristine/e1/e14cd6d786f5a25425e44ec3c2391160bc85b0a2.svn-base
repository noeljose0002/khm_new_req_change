...
<html lang="en" dir="ltr">
	<head>
		...
		#payment_table th.auto-width, #payment_table td.auto-width {
		...
		#send_multiple_iti,#save_cs_btn,#save_iti_btn,#add_new_payment,#btn_save_payment,#btn_update_p_history {
			background: #339966;
			color: white;
		...
		#send_multiple_iti:hover,#save_cs_btn:hover,#save_iti_btn:hover,#add_new_payment:hover,#btn_save_payment:hover,#btn_update_p_history:hover {
			background: #006600;
    ...
    $('#payment_table').DataTable({
        ...
        columns: [
            ...
            },
            {
                ...
                render: function(data, type, row, meta) {
                    return global_all_approved == 1
                        ? '<label class="text-success">All Approved</label>'
