            ...
            <div class="app-content icon-content">
                <div class="section">
                    ...
                    <div class="page-header">
                        <div class="page-leftheader">
                            <h4 class="page-title mb-0">Check In/Out Report</h4>
                ...
                <head>
                    ...
                    <style>
                        ...
                        #checkinoutReportTable thead th {
                ...
                <body class="p-4">
                    ...
                    <div id="filterContainer">
                        ...
                        <div id="tableContainer">
                            <div class="card">
                                <div class="card-body p-4">
                                    <table id="checkinoutReportTable" style="width: 100%;">
                                        <thead>
                                            <tr>
...
<script>
    ...
    $(function() {
        ...
        var table = $('#checkinoutReportTable').DataTable({
            ...
            buttons: [{
                ...
                filename: 'check_in_out_report_' + moment().format('YYYYMMDD_HHmmss'),
                exportOptions: {
                    columns: ':visible',
                     orthogonal: 'export'  
            ...
            serverSide: true,
            ajax: {
                url: '<?= site_url("CheckinoutReport/data") ?>',
