                ...
                <div class="section">
                    ...
                    <div class="page-header">
                        <div class="page-leftheader">
                            <h4 class="page-title mb-0">Web 2 Lead Report</h4>
                ...
                <body class="p-4">
                    ...
                    <div id="filterContainer">
                        ...
                        <div id="tableContainer">
                            <div class="card">
                                <div class="card-body p-4">
                                    <table id="Web2LeadReportTable" style="width: 100%;">
                                        <thead>
                                            <tr>
...
<script>
    ...
    $(function() {
        ...
        var table = $('#Web2LeadReportTable').DataTable({
            dom: '<"row"<"col-sm-12 col-md-6"B><"col-sm-12 col-md-6"f>><"row"<"col-sm-12"tr>><"row"<"col-sm-12 col-md-5"i><"col-sm-12 col-md-7"lp>>',
            buttons: [{
                extend: 'excelHtml5',
                text: 'Export Excel',
                className: 'btn btn-outline-primary',
                title: 'Web 2 Lead Report',
                filename: 'Web2LeadReportTable' + moment().format('YYYYMMDD_HHmmss'),
                exportOptions: {
                    columns: ':visible',
                    format: {
                        body: function(data, row, column, node) {
                            // only for the “Source” column index (now 3)
                            if (column === 3) {
                                var sourceMap = {
                                    1: 'Email',
                                    2: 'Reference',
            ...
            serverSide: false,
            ajax: {
                url: '<?= site_url("Web2LeadReport/data") ?>',
                data: function(d) {
