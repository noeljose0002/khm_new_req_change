					...
					<div class="section">
							...
							<div class="page-rightheader">
								<div class="ml-3 ml-auto d-flex">
									...
									<span class="mt-3 mt-md-0 pg-header">
										<a href="<?=site_url('dashboard/view_vehicles/'.$object_class_id); ?>" class="btn btn-success ml-0 ml-md-4 mt-1 "><i class="typcn typcn-eye mr-1"></i>View <?php echo $object_class_name; ?></a>
									</span>
								</div>
							</div>
						</div>
						...
						<div class="row">
							<div class="col-md">
								...
								<form id="myEnquiryForm" method="POST" action="<?=site_url('Dashboard/saveObjectVeh');?>">
									<div class="card-body">
										<div class="row">
											<div class="col-md-4">
												<div class="form-group">
													<label class="form-label" style="color:#039623;"><?php echo $object_class_name; ?> Name <span style="color: red;">*</span></label>
													<input type="text" class="form-control" name="object_name" id="object_name" maxlength="100" value="<?php echo $obj_name; ?>" placeholder="Name" required>	
											...
											<div class="col-md-4">
												<div class="form-group">
													<label class="form-label" style="color:#039623;">Transporter</label>
													<select name="transport_id" id="transport_id" class="form-control select2 custom-select">
														<option value="">Select</option>
														<?php
														foreach ($all_transporter as $tkey => $tval) {
															if($tval['entity_name'] == $object_transport_name){
												...
												<div class="form-group">
													<div class="table-responsive">
														<table class="table table-bordered" id="more_dynamic_field">
															...
															<tr>
																<td><input type="text" name="addmore[0][object_mobile]" placeholder="Mobile No" maxlength="10" class="form-control mobile_list" /></td>
																<td><input type="email" name="addmore[0][object_email]" placeholder="Email" maxlength="25" class="form-control email_list" /></td>
										...
										<div class="row">
											<div class="col-md-4">
												...
												<select name="hub_location_id" id="hub_location_id" class="form-control select2 custom-select">
														<option value="">Select</option>
														<?php
														foreach ($hub_locations as $key => $val) {
															if($val['hub_location_id'] == $hub_exist){
																echo '<option value="' . $val['hub_location_id'] . '" selected>' . $val['hub_location_name'] . '</option>';
															}
															else{
																echo '<option value="' . $val['hub_location_id'] . '">' . $val['hub_location_name'] . '</option>';
															}
														}
														?>
												</select>
											...
											<div class="col-md-4">
												<label class="form-label" style="color:#039623;">Vehicle Model</label>
												<select name="vehicle_model_id" id="vehicle_model_id" class="form-control select2 custom-select">
														<option value="">Select</option>
														<?php
														foreach ($veh_models as $key => $val) {
															if($val['vehicle_model_id'] == $mod_exist){
																echo '<option value="' . $val['vehicle_model_id'] . '" selected>' . $val['vehicle_model_name'] . '</option>';
															}
															else{
																echo '<option value="' . $val['vehicle_model_id'] . '">' . $val['vehicle_model_name'] . '</option>';
															}
														}
														?>
												</select>
											...
											<div class="col-md-4">
												<label class="form-label" style="color:#039623;">Seat Capacity</label>
												<input type="text" class="form-control" id="vehicle_seat_id" value="<?php echo $seat_exist; ?>" name="vehicle_seat_id" inputmode="text" pattern="[A-Za-z0-9-]*" maxlength="20" oninput="this.value = this.value.replace(/[^A-Za-z0-9-]/g, '')">
											</div>
										</div>
										<div class="row" style="padding-top:15px;">
											<div class="col-md-4">
												<label class="form-label" style="color:#039623;">Tour travel day rent</label>
												<input type="text" class="form-control" id="tour_travel_daily_rate" name="tour_travel_daily_rate" value="<?php echo $tour_travel_daily_rate_exist; ?>" inputmode="numeric" pattern="[0-9]*" maxlength="6" oninput="this.value = this.value.replace(/\D/g, '')">
											</div>
											<div class="col-md-4">
												<label class="form-label" style="color:#039623;">Tour travel max KM / Day</label>
												<input type="text" class="form-control" id="tour_travel_max_km" value="<?php echo $tour_travel_max_km_exist; ?>" name="tour_travel_max_km" inputmode="numeric" pattern="[0-9]*" maxlength="6" oninput="this.value = this.value.replace(/\D/g, '')">
											</div>
											<div class="col-md-4">
												<label class="form-label" style="color:#039623;">Extra KM Rate</label>
												<input type="text" class="form-control" id="extra_km_rate" value="<?php echo $extra_km_rate_exist; ?>" name="extra_km_rate" inputmode="numeric" pattern="[0-9]*" maxlength="6" oninput="this.value = this.value.replace(/\D/g, '')">
											</div>
										</div>

										<div class="row" style="padding-top:15px;">
											<div class="col-md-4">
												<label class="form-label" style="color:#039623;">Local travel day rent</label>
												<input type="text" class="form-control" id="local_travel_daily_rate" value="<?php echo $local_travel_daily_rate_exist; ?>" name="local_travel_daily_rate" inputmode="numeric" pattern="[0-9]*" maxlength="6" oninput="this.value = this.value.replace(/\D/g, '')">
											</div>
											<div class="col-md-4">
												<label class="form-label" style="color:#039623;">Local travel max KM / Day</label>
												<input type="text" class="form-control" id="local_travel_max_km" value="<?php echo $local_travel_max_km_exist; ?>" name="local_travel_max_km" inputmode="numeric" pattern="[0-9]*" maxlength="6" oninput="this.value = this.value.replace(/\D/g, '')">
											</div>
											<div class="col-md-4">
												<label class="form-label" style="color:#039623;">Registration No</label>
												<input type="text" class="form-control" id="registration_no" value="<?php echo $registration_no_exist; ?>" name="registration_no" inputmode="text" pattern="[A-Za-z0-9-]*" maxlength="20" oninput="this.value = this.value.replace(/[^A-Za-z0-9-]/g, '')">
											</div>
										</div>

										<div class="row" style="padding-top:15px;">
											<?php 
											if($is_tour_travel_exist){ 
												$checked1 = "checked";
											}
											else{
												$checked1 = "";
											...
											<div class="col-md-4">
												<input type="checkbox" name="is_tour_travel" id="is_tour_travel"  value="1" <?php echo $checked1; ?>>
												<label class="label-default" style="color:#039623;">Is tour travel</label>
											</div>
											<div class="col-md-4">
												<input type="checkbox" name="is_local_travel" id="is_local_travel"  value="1" <?php echo $checked2; ?>>
												<label class="label-default" style="color:#039623;">Is local travel</label>
											</div>
											<div class="col-md-4">
												<input type="checkbox" name="is_active" id="is_active"  value="1" <?php echo $checked3; ?>>
												<label class="label-default" style="color:#039623;">Is Active</label>
											</div>
										</div>
...
<script>
    $(document).ready(function () {
		...
		if(editMode > 0){
			var mobileData = <?php echo json_encode($obj_mobile); ?>;
            var emailData = <?php echo json_encode($obj_email); ?>;
            var addressData = <?php echo json_encode($obj_address); ?>;
