...
<head>
	...
	<!-- Title -->
	<title>KHM - Payment Tracker</title>
	...
	<style>
		...
		#report_table th.auto-width,
		#report_table td.auto-width {
			width: auto;
			...
			<div class="app-content icon-content">
				<div class="section">
					...
					<div class="page-header">
						...
						<div class="page-leftheader" style="padding:5px;">
							<label for="toDate" class="form-label small-label">system</label>
							<select id="selectOptionsystem" class="form-control input-sm">
								<option value="">All</option>
						...
						<div class="page-leftheader" style="padding:5px;">
							<label for="toDate" class="form-label small-label">Payment Status</label>
							<select id="selectOptionpayment" class="form-control input-sm">
								<option value="">All</option>
								<option value="1">Full Received </option>
...
<script>
	function generatereport() {
		...
		var selectOptionsystem = $("#selectOptionsystem").val();
		var selectOptionpayment = $('#selectOptionpayment').val();
		...
		if ((fromDate == "") || (toDate == "")) {
			...
			$('#report_table').DataTable({
				...
				'ajax': {
					'url': '<?= site_url('Enquiry/get_advanced_payment_tracker_data'); ?>',
					'type': 'POST',
					'data': function(d) {
						...
						d.selectOptionsystem = selectOptionsystem;
						d.selectOptionpayment = selectOptionpayment;
					}
				},
				...
				'initComplete': function() {
					...
					$("div.report-title").html(
						'<h5 style="margin-top: 6px;font-weight: bold;font-style: italic;color:#006600">Payment Tracker: ' + formattedFromDate + ' to ' + formattedToDate + '</h5>'
					);
				}
			});
