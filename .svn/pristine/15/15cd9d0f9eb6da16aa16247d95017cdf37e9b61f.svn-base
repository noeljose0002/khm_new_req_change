													...
													<div class="col-md-6">
														<div class="form-group">
															...
															?>
																		...
																		<?php } else if ($vals['object_mst_attribute_data_type'] == "select_rating") { ?>
																			<select class="form-control select2 custom-select" name="attribute[0][<?php echo $vals['object_class_attribute_id']; ?>]" id="attr<?php echo $vals['object_mst_attribute_name']; ?>">
																				<option value="">Select</option>
																				<?php
																		...
																		<?php
																		} else if ($vals['object_mst_attribute_data_type'] == "select_state") { ?>
																			<select class="form-control select2 custom-select" name="attribute[0][<?php echo $vals['object_class_attribute_id']; ?>]" id="attr<?php echo $vals['object_mst_attribute_name']; ?>" required>
																				<option value="">Select</option>
																				<?php
																				foreach ($all_locations2 as $key => $val) {
																					$selected = ($avals['object_attribute_value'] == $val['geog_id']) ? 'selected' : '';
																					echo '<option value="' . $val['geog_id'] . '" ' . $selected . '>' . $val['geog_name'] . '</option>';
																				}
																				?>
																			</select>
																		<?php } else if ($vals['object_mst_attribute_data_type'] == "textarea") { ?>
