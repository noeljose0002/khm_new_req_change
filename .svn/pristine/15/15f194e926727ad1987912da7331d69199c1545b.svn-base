...
<html lang="en" dir="ltr">
	<head>
		...
		<style>
			#performance_chart,#monthly_sales,#lead_management,#source_of_leads {
				background: #006699;
				color: white;
			...
			#performance_chart:hover,#monthly_sales:hover,#lead_management:hover,#source_of_leads:hover {
				background: #00334d;
							...
							<div class="page-rightheader">
								<div class="ml-3 ml-auto d-flex">
									<div class="mt-3 mt-md-0">
										<a href="#source_leads"><button type="button" id="source_of_leads" class="btn btn-success">Source Of Leads</button></a>
									</div>
									<div class="mt-3 mt-md-0">
										<a href="#sales_chart"><button type="button" id="monthly_sales" class="btn btn-success">Monthly Sales</button></a>
									</div>
									<div class="mt-3 mt-md-0">
										<a href="#leads_mn"><button type="button" id="lead_management" class="btn btn-success">Lead Management</button></a>
									</div>
									<span class="mt-3 mt-md-0 pg-header">
										<a href="#per_chart"><button type="button" id="performance_chart" class="btn btn-success">Performance Chart</button></a>
									</span>
								</div>
							</div>
						</div>
