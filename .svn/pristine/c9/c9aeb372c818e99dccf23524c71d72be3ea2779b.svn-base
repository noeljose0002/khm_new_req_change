...
use App\Models\SourceReportModel;
use CodeIgniter\HTTP\RequestInterface;
use CodeIgniter\HTTP\ResponseInterface;
use Psr\Log\LoggerInterface;

class SourceReport extends Controller
{
    protected $SourceReportModel;
    ...
    public function initController(
        ...
        $this->SourceReportModel = new SourceReportModel();
    }
    ...
    public function index()
    {
        ...
        return view('masters/source_report_list',$data);
    }
    ...
    public function data()
    {
        ...
        // Fetch data
        $rows = $this->SourceReportModel->getByDateRange($fromYmd, $toYmd,$system);
