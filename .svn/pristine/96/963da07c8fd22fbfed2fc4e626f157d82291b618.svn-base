					...
					<div class="section">
							...
							<div class="page-rightheader">
								<div class="ml-3 ml-auto d-flex">
									...
									<span class="mt-3 mt-md-0 pg-header">
										<a href="<?=site_url('dashboard/view_sight_seeing/'.$object_class_id); ?>" class="btn btn-success ml-0 ml-md-4 mt-1 "><i class="typcn typcn-eye mr-1"></i>View <?php echo $object_class_name; ?></a>
									</span>
								</div>
							</div>
						</div>
						...
						<div class="row">
							<div class="col-md">
								...
								<form id="myEnquiryForm" method="POST" action="<?=site_url('Dashboard/saveObjectss');?>" enctype="multipart/form-data">
									<div class="card-body">
										<div class="row">
											<div class="col-md-3">
												<div class="form-group">
													<label class="form-label" style="color:#039623;"><?php echo $object_class_name; ?> Name <span style="color: red;">*</span></label>
													<input type="text" class="form-control" name="object_name" id="object_name" maxlength="30" value="<?php echo $obj_name; ?>" placeholder="Name" required>	
											...
											<div class="col-md-3">
												<div class="form-group">
													<label class="form-label" style="color:#039623;">Distance</label>
													<input type="text" class="form-control" name="sightseeing_distance" id="sightseeing_distance" placeholder="Distance" value="<?php echo $sightseeing_distance_exist; ?>" inputmode="decimal" pattern="[0-9]*" maxlength="6" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">	
												</div>
											</div>

											<div class="col-md-3">
												<div class="form-group">
													<label class="form-label" style="color:#039623;">Vendor</label>
													<select name="vendor_id" id="vendor_id" class="form-control select2 custom-select">
														<option value="">Select</option>
														<?php
														foreach ($all_vendor as $tkey => $tval) {
															if($tval['entity_id'] == $vendor_id_exist){
										...
										<div class="row">
											<div class="col-md-12">
												...
												<textarea row="1" class="form-control" name="sightseeing_description" id="sightseeing_description" placeholder="Sight Seeing Description"><?php echo $sightseeing_description_exist; ?></textarea>
											</div>
										</div>
										<div class="row" style="padding-top:15px">
											<div class="col-md-6">
												<label class="form-label" style="color:#039623;">Upload Image</label>
												<input type="file" name="fileuplaod" id="fileuplaod" aria-label="Upload" class="form-control">
											</div>
											<div class="col-md-6" style="padding-top:40px">
												...
												?>
												<input type="checkbox" name="is_pax" id="is_pax"  value="1" <?php echo $checked; ?>>
												<label class="label-default" style="color:#039623;">Is PAX</label>
											</div>
										</div>
										<div class="row">
											<div class="col-md-12 ">
