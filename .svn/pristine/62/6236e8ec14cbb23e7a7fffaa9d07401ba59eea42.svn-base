    ...
    <div class="page">
        <div class="page-main">
            ...
            <div class="app-content icon-content">
                <div class="section">
                    ...
                    <div class="page-header">
                        <div class="page-leftheader">
                            <h4 class="page-title mb-0">Best Destination Report</h4>
                ...
                <head>
                    <meta charset="utf-8">
                    <title> Best Destination Report</title>
                    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
                    ...
                    <style>
                        ...
                        #bestdestinationReportTable thead th {
                ...
                <body class="p-4">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="form-inline filter-row align-items-center">
                                    ...
                                    <div class="form-group">
                                        <label for="destinationDropdown" class="ml-3 mr-1">Locations:</label>
                    ...
                    <div id="tableContainer">
                        <div class="card">
                            <div class="card-body p-4">
                                <table id="bestdestinationReportTable" style="width: 100%;">
                                    <thead>
                                        <tr>
...
<script>
    ...
    $.ajax({
        url: '<?= site_url("BestDestinationReport/destination") ?>',
        method: 'GET',
        dataType: 'json',
        success: function(destination) {
            destination.forEach(function(agent) {
                $('#destinationDropdown').append(
                    $('<option>').val(agent.id).text(agent.name)
                );
            });
        },
    ...
    $(function() {
        ...
        var table = $('#bestdestinationReportTable').DataTable({
            dom: '<"row"<"col-sm-12 col-md-6"B><"col-sm-12 col-md-6"f>><"row"<"col-sm-12"tr>><"row"<"col-sm-12 col-md-5"i><"col-sm-12 col-md-7"lp>>',
            buttons: [{
                extend: 'excelHtml5',
                text: 'Export Excel',
                className: 'btn btn-outline-primary',
                title: 'Best Destination Report',
                filename: 'Best_Destination_report_' + moment().format('YYYYMMDD_HHmmss'),
                exportOptions: {
                    columns: ':visible',
                    // format: {
