				...
				<div class="section">
					...
					<div class="page-header">
						<div class="page-leftheader">
							...
							<small class="text-muted mt-0 fs-14"> <span style="color:#097a21;">View / Add / Edit <?php echo $entity_class_name; ?> Details</span></small>
						</div>
					...
					<div class="row">
						<div class="col-md">
							<div class="card overflow-hidden">
								<form id="myEnquiryForm" method="POST" action="<?= site_url('Dashboard/saveEntity'); ?>">
									<div class="card-body">
										<div class="row">
											...
											?>
												<div class="col-md-4">
													<div class="form-group">
														...
														<select name="entity_parent_id" id="entity_parent_id" class="form-control select2 custom-select" required>
												...
												<div class="col-md-4">
													<div class="form-group">
														...
														<input type="text" class="form-control" name="entity_name" id="entity_name" maxlength="100" value="<?php echo $ent_name; ?>" placeholder="Name" required>
												...
												<div class="col-md-4">
													<div class="form-group">
														...
														<select name="entity_location" id="entity_location" class="form-control select2 custom-select" required>
															<option value="">Select</option>
															<?php
											...
											<?php } else if ($entity_class_id == 10) {
												if ($status == 1) {
													$ent_parent_id = $edit_id;
												}
													...
													<div class="row">
														...
														if (!empty($attributes)) {
															foreach ($attributes as $keys => $vals) {
																if ($vals['entity_attribute_data_type'] == "select_state" && !$state_rendered) {
																	$state_rendered = true;
														?>
																	<div class="col-md-12">
																		<div class="form-group">
																			...
																			?>
																						...
																						<label class="form-label" style="color:#039623;">Agent State</label>
																						<select class="form-control select2 custom-select select-state"
																							name="attribute[0][<?php echo $vals['entity_class_attr_id']; ?>]"
																							id="attr<?php echo $vals['entity_attribute_name']; ?>"
																							data-entity-class-id="<?php echo $entity_class_id; ?>"
																							required>
																							<option value="">Select State</option>
																							<?php foreach ($state_locations as $skeys => $svals): ?>
																								<option value="<?= $svals['geog_id'] ?>" <?= (isset($avals['entity_attr_value']) && $avals['entity_attr_value'] == $svals['geog_id']) ? 'selected' : '' ?>>
																									<?= esc($svals['geog_name']) ?>
																								</option>
																							<?php endforeach; ?>
																						</select>
																				...
																				<select class="form-control select2 custom-select select-state"
																					...
																					<option value="">Select State</option>
																					<?php foreach ($state_locations as $skeys => $svals): ?>
																						<option value="<?= $svals['geog_id'] ?>"
																							<?= (isset($avals['entity_attr_value']) && $avals['entity_attr_value'] == $svals['geog_id']) ? 'selected' : '' ?>>
																							<?= esc($svals['geog_name']) ?>
																						</option>
																					<?php endforeach; ?>
																				</select>
												...
												<div class="form-group">
													<div class="table-responsive">
														<table class="table table-bordered" id="more_dynamic_field">
															<tr>
																<th style="color:#039623;">Mobile No</th>
																<th style="color:#039623;">Email</th>
																<th style="color:#039623;">Address</th>
																<th style="color:#039623;">Action</th>
															</tr>
															<?php if (empty($edit_id) || (!empty($edit_id) && $status == 1)) { ?>
																<tr>
																	<td><input type="text" name="addmore[0][entity_mobile]" placeholder="Mobile No" maxlength="10" class="form-control mobile_list" /></td>
																	<td><input type="email" name="addmore[0][entity_email]" placeholder="Email" maxlength="100" class="form-control email_list" /></td>
																	<td><textarea name="addmore[0][entity_address]" placeholder="Address" class="form-control address_list"></textarea></td>
										...
										<div class="row">
											<?php if (!empty($attributes)) {
												foreach ($attributes as $keys => $vals) {
													// Skip Agent State field - don't display it
													if (strtolower($vals['entity_attribute_name']) == 'agent state') {
														continue;
													}
											?>
													<div class="col-md-6">
														<div class="form-group">
															...
															?>
																		...
																		<?php if ($vals['entity_attribute_data_type'] == "select_hotel") { ?>
																			<select class="form-control select2 custom-select" name="attribute[0][<?php echo $vals['entity_class_attr_id']; ?>]" id="attr<?php echo str_replace(' ', '', $vals['entity_attribute_name']); ?>">
																		...
																		<?php } else if ($vals['entity_attribute_data_type'] == "select_vehicle") { ?>
																			<select class="form-control select2 custom-select" name="attribute[0][<?php echo $vals['entity_class_attr_id']; ?>]" id="attr<?php echo str_replace(' ', '', $vals['entity_attribute_name']); ?>">
																		...
																		<?php } else if ($vals['entity_attribute_data_type'] == "select_state") { ?>
																			<select class="form-control select2 custom-select select-state"
																				name="attribute[0][<?php echo $vals['entity_class_attr_id']; ?>]"
																				id="attr<?php echo str_replace(' ', '', $vals['entity_attribute_name']); ?>"
																				data-entity-class-id="<?php echo $entity_class_id; ?>"
																				required>
																				<option value="">Select State</option>
																				<?php foreach ($state_locations as $skeys => $svals): ?>
																		...
																		<?php } else { ?>
																			<input type="<?php echo $vals['entity_attribute_data_type']; ?>" class="form-control" name="attribute[0][<?php echo $vals['entity_class_attr_id']; ?>]" id="attr<?php echo str_replace(' ', '', $vals['entity_attribute_name']); ?>" value="<?php echo $avals['entity_attr_value']; ?>">
																<?php }
																	}
																}
															} else { ?>
																<label class="form-label" style="color:#039623;"><?php echo $vals['entity_attribute_name']; ?></label>
																<?php if ($vals['entity_attribute_data_type'] == "select_hotel") { ?>
																	<select class="form-control select2 custom-select" name="attribute[0][<?php echo $vals['entity_class_attr_id']; ?>]" id="attr<?php echo str_replace(' ', '', $vals['entity_attribute_name']); ?>" required>
																		<option value="">Select Hotel</option>
																		<?php
																		foreach ($hotel_list as $hkeys => $hvals) {
																			echo '<option value="' . $hvals['hotel_id'] . '">' . $hvals['object_name'] . '</option>';
																...
																<?php } else { ?>
																	<input type="<?php echo $vals['entity_attribute_data_type']; ?>" class="form-control" name="attribute[0][<?php echo $vals['entity_class_attr_id']; ?>]" id="attr<?php echo str_replace(' ', '', $vals['entity_attribute_name']); ?>" placeholder="<?php echo $vals['entity_attribute_name']; ?>">
															<?php }
															} ?>
														</div>
													</div>
											...
											<?php if ($entity_class_id == 3) { ?>
												<div class="col-md-6">
													<div class="form-group">
														...
														<?php if (!empty($login_details)) { ?>
															<input type="text" class="form-control" name="login_username" id="login_username" placeholder="Username" maxlength="30" value="<?php echo $login_details[0]['user_id']; ?>" required>
														<?php } else { ?>
															<input type="text" class="form-control" name="login_username" id="login_username" placeholder="Username" disabled required>
														<?php } ?>
												...
												<div class="col-md-6">
													<div class="form-group">
														...
														<input type="password" class="form-control" name="login_password" maxlength="30" id="login_password" placeholder="Password" disabled required>
...
<script>
	// expose server-side values to JS
	var preSelectedLoc = '<?php echo isset($ent_loc) ? $ent_loc : ""; ?>';
	var preSelectedLocName = '<?php echo isset($ent_loc_name) ? addslashes($ent_loc_name) : ""; ?>';
	var preSelectedState = '<?php echo isset($ent_state) ? $ent_state : ""; ?>';
</script>
...
<script>
	...
	jQuery(function($) {
	// Function to load locations based on state
	function loadLocationsByState(stateId, entityClassId) {
		var $loc = $('#entity_location');
		$loc.prop('disabled', true).html('<option value="">Loading...</option>');
		
		if (!stateId) {
			$loc.html('<option value="">Select</option>').prop('disabled', false);
			if ($loc.hasClass('select2-hidden-accessible')) $loc.trigger('change.select2');
			return;
		}

		$.ajax({
			url: '<?= site_url("Dashboard/get_by_state") ?>',
			type: 'GET',
			data: {
				state_id: stateId
			},
			...
			success: function(resp) {
				...
				if (Array.isArray(resp) && resp.length) {
					resp.forEach(function(r) {
						var isSelected = (preSelectedLoc && preSelectedLoc == r.geog_id);
						if (isSelected) foundPreSelected = true;
						html += '<option value="' + r.geog_id + '"' + (isSelected ? ' selected' : '') + '>' + r.geog_name + '</option>';
					});
				} else {
					html = '<option value="">No locations found</option>';
				}

				$loc.html(html).prop('disabled', false);

				// ensure Select2 shows the selected value
				if (preSelectedLoc) {
					$loc.val(preSelectedLoc);
					if ($loc.hasClass('select2-hidden-accessible')) $loc.trigger('change.select2');
				} else if ($loc.hasClass('select2-hidden-accessible')) {
					$loc.trigger('change.select2');
				}
			},
			error: function(xhr, status, err) {
				console.error('AJAX error', status, err);
				$('#entity_location').html('<option value="">Error loading</option>').prop('disabled', false);
			}
		});
	}

	// Delegate in case state select is dynamic
	$(document).on('change', '.select-state', function() {
		var stateId = $(this).val();
		var entityClassId = $(this).data('entity-class-id') || $('#entity_class_id').val();
		
		// only for entity_class_id == 4 (your condition)
		if (parseInt(entityClassId, 10) !== 4) return;
		
		loadLocationsByState(stateId, entityClassId);
	});

	// Handle page load/reload - check if there are preselected values
	$(document).ready(function() {
		var $stateSelect = $('.select-state');
		var currentStateId = preSelectedState || $stateSelect.val();
		var entityClassId = $stateSelect.data('entity-class-id') || $('#entity_class_id').val();
		
		// Only proceed if entity_class_id == 4 and there's a state selected
		if (parseInt(entityClassId, 10) === 4 && currentStateId) {
			// Set the state value if preSelectedState exists
			if (preSelectedState) {
				$stateSelect.val(preSelectedState);
			}
			
			// Load locations for the current state
			loadLocationsByState(currentStateId, entityClassId);
		} else if (preSelectedLoc && !currentStateId) {
			// If there's a preSelectedLoc but no state, ensure the select displays it
			var $loc = $('#entity_location');
			$loc.val(preSelectedLoc);
			if ($loc.hasClass('select2-hidden-accessible')) $loc.trigger('change.select2');
		}
	...
	$(document).ready(function() {
		...
		if (editMode > 0) {
			...
			$.each(mobileData, function(index, mobile) {
                ...
                <tr>
                    <td>
                        <input type="text" name="addmore[${index}][entity_mobile]" value="${mobile}" placeholder="Mobile No" class="form-control mobile_list" />
                    </td>
                    <td>
                        <input type="text" name="addmore[${index}][entity_email]" value="${email}" placeholder="Email" class="form-control email_list" />
                    </td>
                    <td>
                        <textarea name="addmore[${index}][entity_address]" placeholder="Address" class="form-control address_list">${address}</textarea>
                    </td>
                    <td>
                        ${index === 0 ? `
			...
			$(document).on('click', '#add_more_det', function() {
                ...
                <tr>
                    <td>
                        <input type="text" name="addmore[${rowCount}][entity_mobile]" placeholder="Mobile No" class="form-control mobile_list" />
                    </td>
                    <td>
                        <input type="text" name="addmore[${rowCount}][entity_email]" placeholder="Email" class="form-control email_list" />
                    </td>
                    <td>
                        <input type="text" name="addmore[${rowCount}][entity_address]" placeholder="Address" class="form-control address_list" />
                    </td>
                    <td>
                        <button type="button" class="btn btn-danger remove-row">
                            <i class="fa fa-minus"></i>
