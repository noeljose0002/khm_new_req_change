...
use App\Models\GroupEnquiryMisReportModel;
...
class GroupEnquiryMisReport extends Controller
{
    /** @var GroupEnquiryMisReportModel */
    protected $GroupEnquiryMisReportModel;
    ...
    public function initController(
        ...
        $this->GroupEnquiryMisReportModel = new GroupEnquiryMisReportModel();
    }
    ...
    public function index()
    {
        ...
        return view('masters/group_mis_report_list', $data);
    }
    ...
    public function data()
    {
        ...
        $agents_id  = $this->request->getGet('agents_id');
        ...
        // Fetch data
        $rows = $this->GroupEnquiryMisReportModel->getByDateRange($fromYmd, $toYmd, $executive_id, $agents_id,$status_id,$system);
    ...
    {
        $model  = new GroupEnquiryMisReportModel();
