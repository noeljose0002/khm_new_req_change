...
use App\Models\GuestTrackingReportModel;
use CodeIgniter\HTTP\RequestInterface;
use CodeIgniter\HTTP\ResponseInterface;
use Psr\Log\LoggerInterface;

class GuestTrackingReport extends Controller
{
    protected $GuestTrackingReportModel;
    ...
    public function initController(
        ...
        $this->GuestTrackingReportModel = new GuestTrackingReportModel();
    }
    ...
    public function index()
    {
        ...
        return view('masters/guest_tracking_report_list', $data);
    }
    public function data()
    {
        ...
        // Fetch data
        $rows = $this->GuestTrackingReportModel->getByDateRange($fromYmd,$system);
