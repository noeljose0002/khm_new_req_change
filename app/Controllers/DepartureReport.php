...
use App\Models\DepartureReportModel;
...
class DepartureReport extends Controller
{
    /** @var DepartureReportModel */
    protected $DepartureReportModel;
    ...
    public function initController(
        ...
        $this->DepartureReportModel = new DepartureReportModel();
    }
    ...
    public function index()
    {
        ...
        return view('masters/departure_report_list',$data);
    }
    ...
    public function data()
    {
        ...
        // Fetch data
        $rows = $this->DepartureReportModel->getByDateRange($fromYmd, $toYmd,$system);
