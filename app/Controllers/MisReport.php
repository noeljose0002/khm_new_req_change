...
class MisReport extends Controller
{
    /** @var MisReportModel */
    protected $MisReportModel;
    ...
    public function initController(
        ...
        $this->MisReportModel = new MisReportModel();
    }
    ...
    public function index()
    {
        ...
        return view('masters/mis_report_list', $data);
    }
    ...
    public function data()
    {
        ...
        // Fetch data
        $rows = $this->MisReportModel->getByDateRange($fromYmd, $toYmd, $executive_id, $agents_id,$status_id,$system);
