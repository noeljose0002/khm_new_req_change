...
use App\Models\Web2LeadReportModel;
use CodeIgniter\HTTP\RequestInterface;
use CodeIgniter\HTTP\ResponseInterface;
use Psr\Log\LoggerInterface;

class Web2LeadReport extends Controller
{
    protected $Web2LeadReportModel;
    ...
    public function initController(
        ...
        $this->Web2LeadReportModel = new Web2LeadReportModel();
    }
    ...
    public function index()
    {
        ...
        return view('masters/Web2Lead_report_list',$data);
    }
    ...
    public function data()
    {
        ...
        // Fetch data
        $rows = $this->Web2LeadReportModel->getByDateRange($fromYmd, $toYmd,$system);
