...
use App\Models\BestAgentReportModel;
...
class BestAgentReport extends Controller
{
    /** @var BestAgentReportModel */
    protected $BestAgentReportModel;
    ...
    public function initController(
        ...
        $this->BestAgentReportModel = new BestAgentReportModel();
    }
    ...
    public function index()
    {
        ...
        return view('masters/best_agent_report_list', $data);
    }

    public function agents(): ResponseInterface
    {
        $model  = new BestAgentReportModel();
    ...
    public function data()
    {
        ...
        $agentId  = $this->request->getGet('agent_id', FILTER_SANITIZE_STRING);
        ...
        // Fetch data
        $rows = $this->BestAgentReportModel->getByDateRange($fromYmd, $toYmd,$agentId,$system);
