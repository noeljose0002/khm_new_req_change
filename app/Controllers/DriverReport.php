...
use App\Models\DriverReportModel;
...
class DriverReport extends Controller
{
    /** @var DriverReportModel */
    protected $DriverReportModel;
    ...
    public function initController(
        ...
        $this->DriverReportModel = new DriverReportModel();
    }
    ...
    public function index()
    {
        ...
        return view('masters/driver_report_list',$data);
    }
    ...
    public function data()
    {
        ...
        // Fetch data
        $rows = $this->DriverReportModel->getByDateRange($fromYmd, $toYmd,$system);
