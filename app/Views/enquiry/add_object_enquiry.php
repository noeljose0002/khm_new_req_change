...
if (!empty($date_of_tour_start)) {
	$date_of_tour_start = date('d-m-Y', strtotime($date_of_tour_start));
}
if (!empty($date_of_tour_completion)) {
	$date_of_tour_completion = date('d-m-Y', strtotime($date_of_tour_completion));
}
?>
<!doctype html>
...
<head>
	...
	<style>
		...
		#btn_next:hover,
		#btn_back:hover,
		#btn_save_entity:hover,
		#btn_enq_list_view:hover {
			background: #006600;
																			...
																			<?php if (session('system_id') == "3") { ?>
																				...
																				<div class="row">
																					<div class="col-xl-3">
																						...
																						<?php if (!empty($agent_details)) { ?>
																							<select class="form-control" name="agent_state" id="agent_state" onchange="selectagent()" required <?php echo $dis_abled; ?>>
																					...
																					<div class="col-xl-3">
																						...
																						<select class="form-control" name="agent_id" id="agent_id" onchange="selectagentdet()" required>
																							<option value="">Select</option>
																					...
																					<div class="col-xl-6">
																						...
																						<textarea id="agent_address" name="agent_address" class="form-control" readonly></textarea>
																					</div>
																				...
																				<div class="row" style="padding-top:15px;">
																					<div class="col-xl-3" class="form-label" style="color:#039623;">
																						...
																						<input type="text" class="form-control" id="guest_name" name="guest_name" value="<?php echo $obj_name; ?>" autocomplete="off" maxlength="40" pattern="^[A-Za-z]+(?: [A-Za-z]+)*$" oninput="this.value = this.value.replace(/[^A-Za-z ]/g, '').replace(/^ /g, '')" required>
																					...
																					<div class="col-xl-2" style="color:#039623;">
																						...
																						<select class="form-control" name="no_of_arrivals" id="no_of_arrivals">
																			...
																			<?php } else { ?>
																				...
																				<div class="row">
																					<div class="col-xl-3">
																						...
																						<input type="text" class="form-control" id="guest_name" name="guest_name" value="<?php echo $obj_name; ?>" autocomplete="off" maxlength="25" pattern="^[A-Za-z]+(?: [A-Za-z]+)*$" oninput="this.value = this.value.replace(/[^A-Za-z ]/g, '').replace(/^ /g, '')" required <?php echo $read_only; ?>>
																						<span id="gname-alert"></span>
																					</div>
																					<div class="col-xl-3">
																						<label class="form-label" style="color:#039623;">Mobile<span style="color: red;">*</span></label>
																						<input type="text" class="form-control" id="guest_mobile" name="guest_mobile" value="<?php echo $obj_mobile; ?>" autocomplete="off" maxlength="10" required <?php echo $read_only; ?>>
																						<span id="gmobile-alert"></span>
																						<span id="mobile_error" style="color: red; display: none;">Enter a valid 10-digit mobile number</span>
																					</div>
																					<div class="col-xl-3">
																						<label class="form-label" style="color:#039623;">Email<span style="color: red;">*</span></label>
																						<input type="email" class="form-control" name="guest_email" id="guest_email" value="<?php echo $obj_email; ?>" autocomplete="off" maxlength="30" required <?php echo $read_only; ?>>
																						<span id="gemail-alert"></span>
																						<span id="email_error" style="color: red; display: none;">Invalid email format</span>
																					</div>
																					<div class="col-xl-3">
																						<label class="form-label" style="color:#039623;">Address<span style="color: red;">*</span></label>
																						<textarea class="form-control" name="guest_address" id="guest_address" autocomplete="new-password" required <?php echo $read_only; ?>><?php echo $obj_address; ?></textarea>
																						<span id="gaddress-alert"></span>
																					</div>
																				...
																				<div class="">
																					<div class="row">
																						<div class="col-xl-3">
																							...
																							<input type="text" class="form-control" id="tour_start_date" name="tour_start_date" value="<?php echo $date_of_tour_start; ?>" required>
																							<span id="startdate-alert"></span>
																						</div>
																						<div class="col-xl-3">
																							<label class="form-label" style="color:#039623;">No Of Night<span style="color: red;">*</span></label>
																							<input type="text" class="form-control" id="no_of_days" name="no_of_days" value="<?php echo $no_of_night; ?>" inputmode="numeric" pattern="[0-9]*" maxlength="2" oninput="this.value = this.value.replace(/\D/g, '')" required>
																							<span id="nodays-alert"></span>
																						</div>
																						<div class="col-xl-3">
																							<label class="form-label" style="color:#039623;">Tour end date<span style="color: red;">*</span></label>
																							<input type="text" class="form-control" id="tour_end_date" name="tour_end_date" value="<?php echo $date_of_tour_completion; ?>" readonly tabindex="-1">
																						</div>
																						<div class="col-xl-3">
																							<label class="form-label" style="color:#039623;">Enquiry Source<span style="color: red;">*</span></label>
																							<select class="form-control" name="enq_source" id="enq_source" required>
																								<option value="">Select</option>
																					...
																					<div class="row source-ref-group">
																						<div class="col-xl-3">
																						...
																						<div class="col-xl-3">
																							<label class="form-label" style="color:#039623;" id="lblsrcref">Source Reference<span style="color: red;">*</span></label>
																							<input type="text" class="form-control" id="source_reference" name="source_reference" value="<?php echo $source_reference; ?>" autocomplete="off" maxlength="25">
																						</div>
																					</div>
																					...
																					<div class="row" style="padding-top:15px;">
																						<div class="col-xl-3">
																							...
																							<input type="text" class="form-control" id="no_of_adult" name="no_of_adult" value="<?php echo $no_of_adult; ?>" inputmode="numeric" pattern="[0-9]*" maxlength="2" oninput="this.value = this.value.replace(/\D/g, '')" required>
																							<span id="nodays-alert"></span>
																						</div>
																						<div class="col-xl-3">
																							<label class="form-label" style="color:#039623;">Child with bed</label>
																							<input type="text" class="form-control" id="no_of_child_with_bed" value="<?php echo $no_of_child_with_bed; ?>" name="no_of_child_with_bed" inputmode="numeric" pattern="[0-9]*" maxlength="2" oninput="this.value = this.value.replace(/\D/g, '')">
																							<span id="nodays-alert"></span>
																						</div>
																						<div class="col-xl-3">
																					...
																					<div class="row" style="padding-top:15px;">
																						<div class="col-xl-3">
																							...
																							<input type="text" class="form-control" id="no_of_double_room" name="no_of_double_room" value="<?php echo $no_of_double_room; ?>" inputmode="numeric" pattern="[0-9]*" maxlength="2" oninput="this.value = this.value.replace(/\D/g, '')" required>
																							<span id="nodays-alert"></span>
																						</div>
																						<div class="col-xl-3">
																							<label class="form-label" style="color:#039623;">No: Of Single Room</label>
																							<input type="text" class="form-control" id="no_of_single_room" value="<?php echo $no_of_single_room; ?>" name="no_of_single_room" inputmode="numeric" pattern="[0-9]*" maxlength="2" oninput="this.value = this.value.replace(/\D/g, '')">
																							<span id="nodays-alert"></span>
																						</div>
																						<div class="col-xl-3">
																							<label class="form-label" style="color:#039623;">No: Of Extra bed</label>
																							<input type="text" class="form-control" id="no_of_extra_bed" value="<?php echo $no_of_extra_bed; ?>" name="no_of_extra_bed" inputmode="numeric" pattern="[0-9]*" maxlength="2" oninput="this.value = this.value.replace(/\D/g, '')">
																							<span id="nodays-alert"></span>
																						</div>
																						<div class="col-xl-3">
																							<label class="form-label" style="color:#039623;">GSTIN</label>
																							<input type="text" class="form-control" id="gstin" value="" name="gstin" maxlength="20" oninput="this.value = this.value.replace(/[^a-zA-Z0-9]/g, '')">
																							<span id="nodays-alert"></span>
																						</div>
																					</div>
																					...
																					<div class="row" style="padding-top:15px;">
																						<div class="col-xl-3">
																							...
																							<select class="form-control" name="arrival_location" id="arrival_location" required>
																								<option value="">Select</option>
																						...
																						<div class="col-xl-3">
																							...
																							<select class="form-control" name="meal_plan" id="meal_plan" required>
																								<option value="">Select</option>
																								<?php
																					...
																					<div class="row" style="padding-top:15px;">
																						<div class="col-xl-3">
																							...
																							<select class="form-control" name="is_vehicle_req" id="is_vehicle_req" required>
																								<option value="">Select</option>
																						...
																						<div class="col-xl-3">
																							...
																							<select class="form-control" name="hub_location" id="hub_location" onchange="select_vehicle()">
																								<option value="">Select</option>
																								<?php
																						...
																						<div class="col-xl-3">
																							...
																							<?php if ($edit_id > 0) { ?>
																								<select class="form-control" name="is_ss_req" id="is_ss_req" required <?php echo $dis_abled; ?>>
																									<option value="">Select</option>
																									<option value="1" <?php echo $syes_sel; ?>>Yes</option>
																									<option value="0" <?php echo $sno_sel; ?>>No</option>
																								</select>
																							<?php } else { ?>
																								<select class="form-control" name="is_ss_req" id="is_ss_req" required>
																									<option value="">Select</option>
																					...
																					<div class="row" style="padding-top:15px;">
																						<div class="col-xl-3">
																							...
																							<?php if ($edit_id > 0) { ?>
																								<select class="form-control" name="is_qq_req" id="is_qq_req" required>
																									<option value="">Select</option>
																						...
																						<div class="col-xl-9">
																							...
																							<textarea rows="1" class="form-control" name="enq_description" id="enq_description" placeholder="Description"><?php echo $enq_description; ?></textarea>
																						</div>
																					</div>
																					<?php if ($active_role == 6) { ?>
																						<div class="row source-ref-group">
																							<div class="col-xl-3">
																								<label class="form-label" style="color:#039623;">Assigned To<span style="color: red;">*</span></label>
																								<select class="form-control" name="sales_support_assigned_to" id="sales_support_assigned_to" required>
																									<option value="">Select</option>
																									<?php
																									foreach ($employees_all as $ekeys => $emps) {
																										if ($emps['entity_id'] == $sales_support_assigned_to) {
																											echo '<option value="' . $emps['entity_id'] . '" selected>' . $emps['entity_name'] . '</option>';
																										} else {
																											echo '<option value="' . $emps['entity_id'] . '">' . $emps['entity_name'] . '</option>';
																										}
																									}
																									?>
																								</select>
																					...
																					<?php } else { ?>
																						<input type="hidden" name="sales_support_assigned_to" id="sales_support_assigned_to" value="0">
																					<?php } ?>


																					<div class="row" style="padding-top:15px;">
																						<div class="col-xl-3">
																							<button type="button" id="btn_back" class="btn btn-success" style="float:left;">
																								<< Back</button>
																						</div>
																						<div class="col-xl-3">
																						</div>
...
<script>
	function select_vehicle() {
		var hub_location = $('#hub_location').val(); // use this variable
		...
		$.ajax({
			...
			method: "POST",
			data: {
				location_id: hub_location
			},
			success: function(data) {
				$('#vehicle_type').html(data); // if your PHP returns ready-made <option> HTML
			},
			error: function(xhr, status, error) {
				console.error('getVehicleTypes error:', status, error);
			}
		});
	}
</script>
		...
		if (agent_id == "") {
			...
			$.ajax({
				...
				success: function(data) {
					...
					var address_temp = JSON.parse(data[0].entity_address)[0];
	...
	$(document).ready(function() {
		$('#no_of_days, #tour_start_date').on('input change', function() {
			...
			if (startDate && noOfDays > 0) {
				// ✅ Split and reformat dd-mm-yyyy to proper JS Date
				...
				var endDate = dd + '-' + mm + '-' + yyyy; // output in dd-mm-yyyy format
...
<script>
	$(document).ready(function() {
		...
		var agentid = <?php echo $agentid; ?>;
		var is_vehicle_required = <?php echo $is_vehicle_required ? 1 : 0; ?>;
		var hub_location_id = <?php echo $vehicle_from_location ? $vehicle_from_location : 0; ?>;
		
		// Load agent data first (existing code - keep this)
		if (edit_id > 0 && agent_state_id > 0) {
			setTimeout(() => {
				$('#agent_state').trigger('change');
				setTimeout(() => {
		...
		// Load vehicles - IMPROVED VERSION
		if (edit_id > 0 && is_vehicle_required == 1 && hub_location_id > 0) {
			setTimeout(() => {
				// First, set hub location to populate vehicle types
				$('#hub_location').val(hub_location_id).trigger('change');
				
				// Then load saved vehicles after hub location loads vehicle types
				setTimeout(() => {
					loadSavedVehicles();
				}, 800);
			}, 1000);
		...
		function loadSavedVehicles() {
			...
			if (!vehicles || !Array.isArray(vehicles) || vehicles.length === 0) {
				console.log('No vehicles to load or invalid format');
				return;
			}
			
			// Process each vehicle with proper validation
			vehicles.forEach(function(item, index) {
				// Validate item exists and has required properties
				if (!item || typeof item !== 'object') {
					console.warn('Invalid vehicle item at index', index, item);
					return; // Skip this item
				}
				
				if (!item.vehicle_type_id) {
					console.warn('Missing vehicle_type_id for item:', item);
					return; // Skip this item
				}
				
				var vehicle_type_id = item.vehicle_type_id;
				var vehicle_count = item.vehicle_count || 1; // Default to 1 if missing
				
				// Stagger each vehicle addition
				setTimeout(() => {
					// Check if vehicle type option exists in dropdown
					var $option = $('#vehicle_type option[value="' + vehicle_type_id + '"]');
					
					if ($option.length === 0) {
						console.warn('Vehicle type not found in dropdown:', vehicle_type_id);
						return;
					}
					
					// Trigger change to add vehicle row
					$('#vehicle_type').val(vehicle_type_id).trigger('change');
					
					// Set vehicle count after row is added
					setTimeout(() => {
						var $countDropdown = $('#vtype' + vehicle_type_id);
						if ($countDropdown.length > 0) {
							$countDropdown.val(vehicle_count);
							console.log('Set vehicle count:', vehicle_type_id, vehicle_count);
						} else {
							console.warn('Count dropdown not found for vehicle:', vehicle_type_id);
						}
					}, 300);
				}, 400 * index); // Stagger by 400ms per vehicle
			});
		}
	});
</script>
...
<script>
	flatpickr("#tour_start_date", {
		dateFormat: "d-m-Y",
		defaultDate: "<?php echo $date_of_tour_start; ?>",
		minDate: "today"
	});
</script>
<script>
	flatpickr("#tour_end_date", {
		dateFormat: "d-m-Y",
		defaultDate: "<?php echo $date_of_tour_completion; ?>",
		clickOpens: false
	});
</script>
<script>
	$(document).ready(function() {
		function toggleSourceReference() {
			var source = $('#enq_source').val();
			if (source === "2") { // 2 = Reference
				$('#source_reference').show();
				$('#lblsrcref').show();
			} else {
				$('#source_reference').val(''); // clear value
				$('#source_reference').hide();
				$('#lblsrcref').hide();
			}
		}
		...
		// Check when enquiry source changes
		$('#enq_source').on('change', function() {
			toggleSourceReference();
		});
	});
</script>
