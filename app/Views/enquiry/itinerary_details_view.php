				...
				<div class="modal-dialog custom-modal-width" role="document">
					<div class="modal-content">
						<div class="modal-header">
							<h5 class="modal-title" id="example-Modal3">Enquiry Edit Details</h5>
...
<script>
    $(document).on('click', '#save_cs_btn', function (e) {
		...
		var cs_content = tinymce.get('cost_sheet_template').getContent();
...
<script>
    $(document).on('click', '#save_iti_btn', function (e) {
		...
		var iti_content = tinymce.get('iti_sheet_template').getContent();
