            ...
            <div class="app-content icon-content">
                <div class="section">
                    ...
                    <div class="page-header">
                        <div class="page-leftheader">
                            <h4 class="page-title mb-0">Purchase Report</h4>
                ...
                <body class="p-4">
                    ...
                    <div id="filterContainer">
                        <!-- <center><h4 class="mb-4">Check In/Out Report</h4></center> -->
                        <div class="card">
                            <div class="card-body">
                                <div class="form-inline filter-row align-items-center">
                                    <!-- NEW: Check In/Out Report filter dropdown -->
                                    <div class="form-group ml-3">
                                        <label for="check_filter" class="mr-2">Type</label>
                                        <select id="check_filter" class="form-control">
                        ...
                        <div id="tableContainer">
                            <div class="card">
                                <div class="card-body p-4">
                                    <table id="purchaseReportTable" style="width: 100%;">
                                        <thead>
                                            <tr>
    ...
    $(function() {
        ...
        var table = $('#purchaseReportTable').DataTable({
            ...
            buttons: [{
                ...
                filename: 'Purchase_report_' + moment().format('YYYYMMDD_HHmmss'),
                exportOptions: {
                    columns: ':visible',
                    orthogonal: 'export'
            ...
            serverSide: true,
            ajax: {
                url: '<?= site_url("PurchaseReport/data") ?>',

                data: function(d) {
                    d.check_value = ($('#check_filter').val());
            ...
            columns: [{
...

                {
                    ...
                    render: function(data, type) {
                        // display to user in DD-MM-YYYY, but raw for sort/search/export
                        if (type === 'display') {
                            return data ?
                ...
                },
                {
                    ...
                    render: function(data, type, row) {
                        var value = parseFloat(row.total_value) || 0;
                        var tax = parseFloat(row.tax_rate_percent) || 0;
                        var amount = value + (value * tax / 100);
