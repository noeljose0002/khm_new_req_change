                ...
                <div class="section">
                    ...
                    <div class="page-header">
                        <div class="page-leftheader">
                            <h4 class="page-title mb-0">Add New Table Of Table</h4>
                ...
                <body>
                    <div class="container mt-5">
                                ...
                                <form id="addForm">
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-5">
                                            <label for="table_name"> Table Of Table Name</label>
                                            <input
                                                type="text"
                                                class="form-control"
                                                id="table_name"
                            ...
                            <div class="card-body">
                                <form id="editForm">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-5">
                                            <label for="edit_table_name">Table Of Table Name</label>
                                            <input
                                                type="text"
                                                class="form-control"
                                                id="edit_table_name"
                        ...
                        <div class="card mt-4">
                            ...
                            <div class="card-body">
                                <table id="tableOfTable" class="table table-bordered">
                                    <thead></thead>
                                    <tbody></tbody>
                                </table>
                            </div>
...
<script>
    $(document).ready(function() {
        ...
        const table = $('#tableOfTable').DataTable({
            ajax: {
                url: '<?= site_url("SuperAdminTableOfTable/list") ?>',
                dataSrc: 'data'
            },
            columns: [{
                    data: 'table_id',
        ...
        $('#addForm').on('submit', function(e) {
            ...
            $.post('<?= site_url("SuperAdminTableOfTable/create") ?>', $(form).serialize())
                .then(
                    function success() {
                        form.reset(); // reset the form HTMLFormElement
                        table.ajax.reload(); // refresh your DataTable
                        Swal.fire('Saved!', 'Attribute added.', 'success');
                    },
                    function error(xhr) {
                        // grab first validation message, or fall back
        ...
        // 6) SHOW EDIT
        $('#tableOfTable').on('click', '.editBtn', function() {
            const id = $(this).data('id');

            $.ajax({
                    url: `<?= site_url("SuperAdminTableOfTable/edit") ?>/${id}`,
                    dataType: 'json'
                })
                .then(
        ...
        $('#editForm').on('submit', function(e) {
            e.preventDefault();
            const form = this;
            const id = $('#edit_table_id').val();

            $.ajax({
                    url: `<?= site_url("SuperAdminTableOfTable/update") ?>/${id}`,
                    type: 'POST',
                    data: $(form).serialize()
                })
                .then(
        ...
        $('#tableOfTable').on('click', '.deleteBtn', function() {
            const id = $(this).data('id');
            ...
            Swal.fire({
                ...
                $.ajax({
                        url: `<?= site_url("SuperAdminTableOfTable/delete") ?>/${id}`,
                        type: 'DELETE'
                    })
                    .then(
