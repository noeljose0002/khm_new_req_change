            ...
            <div class="app-content icon-content">
                <div class="section">
                    ...
                    <div class="page-header">
                        <div class="page-leftheader">
                            <h4 class="page-title mb-0">MIS Report</h4>
                ...
                <body class="p-4">
                    ...
                    <div id="tableContainer">
                        <div class="card">
                            <div class="card-body p-4">
                                <table id="mistargetReportTable" style="width: 100%;">
                                    <thead>
                                        <tr>
...
<script>
    ...
    $.ajax({
        url: '<?= site_url("MisReport/executive") ?>',
        method: 'GET',
        dataType: 'json',
    ...
    $(function() {
        ...
        var table = $('#mistargetReportTable').DataTable({
            ...
            buttons: [{
                ...
                title: 'MIS Report',
                filename: 'MISReport_report_' + moment().format('YYYYMMDD_HHmmss'),
                exportOptions: {
                    columns: ':visible',
                    // format: {
