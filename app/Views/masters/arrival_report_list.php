                ...
                <div class="section">
                    ...
                    <div class="page-header">
                        <div class="page-leftheader">
                            <h4 class="page-title mb-0">Arrival Report</h4>
                ...
                <!-- Write code here ---------->
                    ...
                    <body class="p-4">
                        ...
                        <div id="tableContainer">
                            <div class="card">
                                <div class="card-body p-4">
                                    <table id="arrivalReportTable" style="width: 100%;">
                                        <thead>
                                            <tr>
                                                <th>Arrival Time</th>
                                                <th>Guest</th>
...
<script>
    ...
    $(function() {
        ...
        var table = $('#arrivalReportTable').DataTable({
            ...
            serverSide: false,
            ajax: {
                url: '<?= site_url("ArrivalReport/data") ?>',
                data: function(d) {
