            ...
            <div class="app-content icon-content">
                <div class="section">
                    ...
                    <div class="page-header">
                        <div class="page-leftheader">
                            <h4 class="page-title mb-0">Best Agent Report</h4>
                ...
                <body class="p-4">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="form-inline filter-row align-items-center">
                                    ...
                                    <div class="form-group">
                                        <label for="agentDropdown" class="ml-4 mr-2">Agent:</label>
                                        <select id="agentDropdown" class="form-control">
                    ...
                    <div id="tableContainer">
                        <div class="card">
                            <div class="card-body p-4">
                                <table id="bestagentReportTable" style="width: 100%;">
                                    <thead>
                                        <tr>
...
<script>
    // Populate agents dropdown via $.ajax
$.ajax({
    url: '<?= site_url("BestAgentReport/agents") ?>',
    method: 'GET',
    dataType: 'json',
    ...
    $(function() {
        ...
        var table = $('#bestagentReportTable').DataTable({
            dom: '<"row"<"col-sm-12 col-md-6"B><"col-sm-12 col-md-6"f>><"row"<"col-sm-12"tr>><"row"<"col-sm-12 col-md-5"i><"col-sm-12 col-md-7"lp>>',
            buttons: [{
                extend: 'excelHtml5',
                text: 'Export Excel',
                className: 'btn btn-outline-primary',
                title: 'Best Agent Report',
                filename: 'Best_Agent_report_' + moment().format('YYYYMMDD_HHmmss'),
                exportOptions: {
                    columns: ':visible',
                    // format: {
