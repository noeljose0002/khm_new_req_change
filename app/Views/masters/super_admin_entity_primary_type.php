            ...
            <div class="app-content icon-content">
                <div class="section">
                    ...
                    <div class="page-header">
                        <div class="page-leftheader">
                            <h4 class="page-title mb-0">Add New Entity Primary Type</h4>
                ...
                <head>
                    ...
                    <style>
                        ...
                        #entityPrimaryTypeTable thead th {
                ...
                <body>
                    <div class="container mt-5">
                                ...
                                <form id="addForm">
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-6">
                                            <label for="entity_type_name"> Entity type Name</label>
                                            <input
                                                type="text"
                                                class="form-control"
                                                id="entity_type_name"
                        ...
                        <div id="editSection" class="card" style="display:none;">
                            ...
                            <div class="card-body">
                                <form id="editForm">
                                    ...
                                    <input type="hidden" id="edit_entity_type_id" name="entity_type_id">

                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            <label for="edit_entity_type_name">Entity Class Name</label>
                                            <input
                                                type="text"
                                                class="form-control"
                                                id="edit_entity_type_name"
                                                name="entity_type_name"
                                                maxlength="20"
                                                required>
                                        </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <table id="entityPrimaryTypeTable" class="table table-bordered">
                                    <thead>
...
<script>
    $(document).ready(function() {
        ...
        const table = $('#entityPrimaryTypeTable').DataTable({
            ajax: {
                url: '<?= site_url("SuperAdminEntityPrimaryType/list") ?>',
                dataSrc: 'data'
            },
            columns: [{
                    data: 'entity_type_id',
        ...
        $('#addForm').submit(function(e) {
            e.preventDefault();
            $.post(
                    '<?= site_url("SuperAdminEntityPrimaryType/create") ?>',
                    $(this).serialize()
                )
                .done(() => {
                    $('#addForm')[0].reset();
                ...
                .fail(xhr => {
                    Swal.fire('Error', xhr.responseJSON?.errors?.entity_type_name || 'Failed', 'error');
                });
        });

        // 5) SHOW EDIT
        $('#entityPrimaryTypeTable').on('click', '.editBtn', function() {
            const id = $(this).data('id');

            $.getJSON(`<?= site_url("SuperAdminEntityPrimaryType/edit") ?>/${id}`, function(data) {
                // Fill the form fields
                $('#edit_entity_type_id').val(data.entity_type_id);
                $('#edit_entity_type_name').val(data.entity_type_name);
        ...
        $('#editForm').submit(function(e) {
            ...
            $.ajax({
                    url: `<?= site_url("SuperAdminEntityPrimaryType/update") ?>/${id}`,
                    type: 'POST',
                    data: $(this).serialize()
                })
                .done(() => {
        ...
        // 8) DELETE
        $('#entityPrimaryTypeTable').on('click', '.deleteBtn', function() {
            const id = $(this).data('id');
            Swal.fire({
                title: 'Delete?',
                ...
                if (res.isConfirmed) {
                    $.ajax({
                            url: `<?= site_url("SuperAdminEntityPrimaryType/delete") ?>/${id}`,
                            type: 'DELETE'
                        })
                        .done(() => {
                            table.ajax.reload();
