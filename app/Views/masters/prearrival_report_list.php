            ...
            <div class="app-content icon-content">
                <div class="section">
                    ...
                    <div class="page-header">
                        <div class="page-leftheader">
                            <h4 class="page-title mb-0">PreArrival Report</h4>
                ...
                <head>
                    ...
                    <style>
                        ...
                        #PreArrivalReportTable thead th {
                ...
                <body class="p-4">
                    ...
                    <div id="tableContainer">
                        <div class="card">
                            <div class="card-body p-4">
                                <table id="PreArrivalReportTable" style="width: 100%;">
                                    <thead>
                                        <tr>
                                            <th>Arrival Time</th>
                                            <th>Guest</th>
...
<script>
    ...
    $(function() {
        ...
        var table = $('#PreArrivalReportTable').DataTable({
            ...
            buttons: [{
                ...
                filename: 'arrival_report_' + moment().format('YYYYMMDD_HHmmss'),
                exportOptions: {
                    columns: ':visible',
                    // format: {
            ...
            serverSide: false,
            ajax: {
                url: '<?= site_url("PreArrivalReport/data") ?>',
                data: function(d) {
