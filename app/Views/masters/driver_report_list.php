            ...
            <div class="app-content icon-content">
                <div class="section">
                    ...
                    <div class="page-header">
                        <div class="page-leftheader">
                            <h4 class="page-title mb-0">Driver Report</h4>
                ...
                <body class="p-4">
                    ...
                    <div id="filterContainer">
                        <!-- <center><h4 class="mb-4">Driver Report</h4></center> -->
                        <div class="card">
                            <div class="card-body">
                    ...
                    <div id="tableContainer">
                        <div class="card">
                            <div class="card-body p-4">
                                <table id="driverReportTable" style="width: 100%;">
                                    <thead>
                                        <tr>
...
<script>
    ...
    $(function() {
        ...
        var table = $('#driverReportTable').DataTable({
            ...
            buttons: [{
                ...
                title: 'Driver Report',
                filename: 'driver_report_' + moment().format('YYYYMMDD_HHmmss'),
                exportOptions: {
                    columns: ':visible',
                    // format: {
            ...
            serverSide: false,
            ajax: {
                url: '<?= site_url("DriverReport/data") ?>',
                data: function(d) {
