					...
					<div class="section">
						...
						<div class="page-header">
							<div class="page-leftheader">
								<h4 class="page-title mb-0">Role Transactions</h4>
								<small class="text-muted mt-0 fs-14">Assign Transactions to Roles</small>
							</div>
									...
									<div class="card-body">
										<div class="table-responsive product-datatable">
											<table id="example" class="table table-striped table-bordered " >
												<thead>
													<tr>
														<th class="w-15p">Role Name</th>
													
														<th class="wd-10p">Transactions</th>
													</tr>
												</thead>
												<tbody>
													<?php foreach($all_roles as $key => $val) { ?>
														<tr>
															...
															<td>
																...
																<a class="slide-item" href="<?=site_url('Dashboard/view_transactions/'.$val['role_id']);?>"><i class="fa fa-eye"></i></a>																
															</td>
														</tr>
													<?php } ?>
												</tbody>
