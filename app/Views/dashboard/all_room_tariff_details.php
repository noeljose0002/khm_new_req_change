																						...
																						<tr>
																							...
																							<?php if(!empty($tariff_exist)){ 
																								...
																								foreach($tariff_exist as $key1 => $val1){ 
																									...
																									?>
																								<?php if($status == "Saved"){ ?>
																									<td class="pt-3-half"><h6 style="color:#339966;font-weight:bold;"><?php echo $status; ?></h6></td>	
																								<?php } else { ?>
																									<td class="pt-3-half"><h6 style="color:#cc0066;font-weight:bold;"><?php echo $status; ?></h6></td>	
																								<?php } ?>
																								<input type="hidden" class="form-control input-sm" id="ep<?php echo $val['room_id']; ?>" value="0" style="width:90px;" inputmode="numeric" pattern="[0-9]*" maxlength="6">
																								
																								
																								<input type="hidden" class="form-control input-sm" id="cp<?php echo $val['room_id']; ?>" value="0" style="width:90px;" inputmode="numeric" pattern="[0-9]*" maxlength="6">
																								
																								
																								<input type="hidden" class="form-control input-sm" id="map<?php echo $val['room_id']; ?>" value="0" style="width:90px;" inputmode="numeric" pattern="[0-9]*" maxlength="6">
																							
																									
																								<input type="hidden" class="form-control input-sm" id="ap<?php echo $val['room_id']; ?>" value="0" style="width:90px;" inputmode="numeric" pattern="[0-9]*" maxlength="6">
																							<?php   }else { ?>
																								<td class="pt-3-half"><?php echo $status; ?></td>	
																								<input type="hidden" class="form-control input-sm" id="ep<?php echo $val['room_id']; ?>" value="0" style="width:90px;" inputmode="numeric" pattern="[0-9]*" maxlength="6">
																								<input type="hidden" class="form-control input-sm" id="cp<?php echo $val['room_id']; ?>" value="0" style="width:90px;" inputmode="numeric" pattern="[0-9]*" maxlength="6">
																								<input type="hidden" class="form-control input-sm" id="map<?php echo $val['room_id']; ?>" value="0" style="width:90px;" inputmode="numeric" pattern="[0-9]*" maxlength="6">
																								<input type="hidden" class="form-control input-sm" id="ap<?php echo $val['room_id']; ?>" value="0" style="width:90px;" inputmode="numeric" pattern="[0-9]*" maxlength="6">
																							...
																							<td>
																								<button type="button" class="btn btn-dark btn-rounded btn-sm my-0" onclick="save_room(<?php echo $val['room_id']; ?>)" data-bs-toggle="tooltip" data-bs-placement="top" title="Update"><i class="fa fa-save"></i></button>
																									<button type="button" class="btn btn-primary btn-rounded btn-sm my-0" onclick="edit_room(<?php echo $val['room_id']; ?>)" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit">
